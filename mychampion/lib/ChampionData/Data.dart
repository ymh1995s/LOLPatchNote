...
class PatchContent_Aatrox{
  static List<String> BorNorM=["상향","상향", "하향","하향","조정", "하향","상향"];
  static List<String> patchVer=["13.9", "13.5","13.1","12.20","12.14","12.10","12.4"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[2],PatchNoteLink.link[1], PatchNoteLink.link[5],
  PatchNoteLink.link[9],PatchNoteLink.link[15]
...
class PatchContent_Ahri{
  static List<String> BorNorM=["상향","상향","하향","하향","하향","하향","조정"];
  static List<String> patchVer=["13.4","12.21","12.17","12.10","12.9","12.5","12.3"];
  static List<String> patchNoteLink= [PatchNoteLink.link[2],PatchNoteLink.link[8],PatchNoteLink.link[12], 
  PatchNoteLink.link[19], PatchNoteLink.link[20], PatchNoteLink.link[24],PatchNoteLink.link[26]];
  static List<List<String>> Detail_Title =[["기본 능력치","R - 혼령 질주"],
  ["Q - 현혹의 구슬"],
  ["E - 매혹"],
  ["기본 지속 효과 - 정기 흡수"],
  ["E - 매혹","R - 혼령 질주"],
  ...
  static List<List<List<String>>> Detail_Content =[[["기본 체력: 570 ⇒ 590", "기본 방어력: 18 ⇒ 21"],
...
class PatchContent_Akali{
  ...
  static List<String> patchVer=["13.11", "12.18","12.15"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLink.link[11],PatchNoteLink.link[14]];
  static List<List<String>> Detail_Title =[
    ["Q - 오연투척검"],
    ["E - 표창곡예"],
  ["W - 황혼의 장막"]];
...
class PatchContent_Anivia{
  ...
  ["Q - 냉기 폭발", "E - 동상"]];
  static List<List<List<String>>> Detail_Content =[[["체력 증가량: 96 ⇒ 92","방어력 증가량: 5.2 ⇒ 4.9"]],
...
class PatchContent_Annie{
  static List<String> BorNorM=["하향","조정","하향", "상향","하향"];
  static List<String> patchVer=["13.7","13.4","13.3","12.12","12.10"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[0], PatchNoteLink.link[2], PatchNoteLink.link[3], PatchNoteLink.link[17],
   PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["E - 용암 방패"],
  ["기본 능력치","E - 용암 방패","R - 소환: 티버"],
  ["기본 능력치", "기본 지속 효과 - 방화광","E - 용암 방패", "R - 소환: 티버"],
  ["Q - 붕괴","R - 소환: 티버"],
  ["E - 용암 방패"]];
  static List<List<List<String>>> Detail_Content =[[["재사용 대기시간: 12/11/10/9/8초 ⇒ 12/11.5/11/10.5/10초", "보호막 흡수량: 60/100/140/180/220 (+주문력의 40%) ⇒ 60/95/130/165/200 (+주문력의 40%)"]],
...
class PatchContent_Aphelios{
  static List<String> BorNorM=["하향","상향","상향","하향", "하향"];
  static List<String> patchVer=["13.11","13.4","12.11","12.10", "12.5"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLink.link[2],PatchNoteLink.link[18], PatchNoteLink.link[19]
...
class PatchContent_Ashe {
  static List<String> BorNorM = ["상향", "조정","상향", "상향","상향","상향"];
  static List<String> patchVer = ["13.6", "13.5","13.1B","12.18","12.5","12.4"];
  static List<String> patchNoteLink = [PatchNoteLink.link[0],PatchNoteLink.link[1],PatchNoteLink.link[4],
  PatchNoteLink.link[11], PatchNoteLink.link[24], PatchNoteLink.link[25]];
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 서리 화살"],
  ["Q - 궁사의 집중","W - 일제 사격","R - 마법의 수정화살"],
  ["기본 능력치"],
  ["Q - 궁사의 집중"],
  ["W - 일제 사격", "R - 마법의 수정화살"],
  ["R - 마법의 수정화살"]];
  static List<List<List<String>>> Detail_Content =[[["서리 효과가 부여된 적 대상 피해량: 110% (+치명타 확률의 75%) ⇒ 115% (+치명타 확률의 75%)"]],
...
class PatchContent_AurelionSol{
  static List<String> BorNorM=["하향", "하향", "하향", "하향", "조정"];
  static List<String> patchVer=["13.11", "13.8","13.6","13.5", "13.3"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLinkPlus.link[1], PatchNoteLink.link[0], PatchNoteLink.link[1],PatchNoteLink.link[3]];
  static List<List<String>> Detail_Title =[
    ["E - 특이점"],
    ["기본 능력치"],
...
class PatchContent_Azir{
  static List<String> BorNorM=["상향", "상향","조정", "하향","하향","하향","상향"];
  static List<String> patchVer=["13.11","13.7", "13.5","13.4","12.17","12.10","12.6"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLinkPlus.link[0], PatchNoteLink.link[1],PatchNoteLink.link[2],
...
class PatchContent_Bard{
  ...
  static List<List<String>> Detail_Title =[["W - 수호자의 성소"],
  ["기본 지속 효과 - 방랑자의 부름", "W - 수호자의 성소"]];
  static List<List<List<String>>> Detail_Content =[[["최소 체력 회복량 30/60/90/120/150 (+주문력의 30%) ⇒ 25/50/75/100/125 (+주문력의 30%)", "최대 체력 회복량 60/105/150/195/240 (+주문력의 60%) ⇒ 50/80/110/140/170/200 (+주문력의 60%)"]],
...
class PatchContent_Belveth{
  ...
  static List<String> patchVer=["13.9","12.21","12.12"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[2],PatchNoteLink.link[8],PatchNoteLink.link[17]];
  static List<List<String>> Detail_Title =[
    ["기본 능력치","Q - 공허 쇄도"],
    ["E - 여제의 소용돌이", "R - 끝없는 연회"],
...
class PatchContent_Blitzcrank{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[8],PatchNoteLink.link[9], PatchNoteLink.link[10],
  PatchNoteLink.link[17] ,PatchNoteLink.link[25]];
  static List<List<String>> Detail_Title =[["기본 능력치", "W - 폭주"],
  ["기본 능력치", "기본 지속 효과 - 마나 보호막","W - 폭주", "E - 강철 주먹"],
  ["기본 능력치","W - 폭주","E - 강철 주먹","R - 정전기장"],
  ["Q - 로켓 손","R - 정전기장"],
  ["기본 능력치"]];
  static List<List<List<String>>> Detail_Content =[[["기본 체력: 653⇒633", "기본 마법 저항력: 32⇒28"],
...
class PatchContent_Brand{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 불길"],
  ["기본 지속 효과 - 불길", "R - 파멸의 불덩이"]];
  static List<List<List<String>>> Detail_Content =[[["기본 불태우기 피해량 4초에 걸쳐 대상 최대 체력의 3% ⇒ 4초에 걸쳐 대상 최대 체력의 2.5%", "폭발 불태우기 피해량 대상 최대 체력의 10~14% (1~17레벨에서) ⇒ 대상 최대 체력의 9~13% (1~17레벨에서)"]],
...
class PatchContent_Braum{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 뇌진탕 펀치","Q - 동상","W - 내가 지킨다"],
  ["기본 지속 효과 - 뇌진탕 펀치","E - 불굴"]];
  static List<List<List<String>>> Detail_Content =[[["대상 면역 지속시간: 8/6/4초 (1/7/13레벨에서) ⇒ 8/6/4초 (1/6/11레벨에서)"],
...
class PatchContent_Caitlyn{
  static List<String> BorNorM=["하향","상향","상향","조정", "상향","하향"];
  static List<String> patchVer=["13.5","13.1B","12.16","12.12","12.11","12.3"];
  static List<String> patchNoteLink= [PatchNoteLink.link[1],PatchNoteLink.link[4],PatchNoteLink.link[13],
  ...
  ["기본 능력치","Q - 필트오버 피스메이커"]];
  static List<List<List<String>>> Detail_Content =[[["기본 방어력: 28 ⇒ 27", "기본 공격력: 62 ⇒ 60"]],
...
class PatchContent_Camille{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 적응형 방어 체계","E - 갈고리 발사/갈고리 돌진"],
  ["기본 지속 효과 - 적응형 방어체계"]];
  static List<List<List<String>>> Detail_Content =[[["최대 체력 비례 보호막 흡수량 17% ⇒ 20%"],
...
class PatchContent_Corki{
  ...
  ["E - 개틀링 건", "R - 미사일 폭격"],
  ["기본 지속 효과 - 마법공학 탄약"]];
  static List<List<List<String>>> Detail_Content =[[["체력 증가량: 101⇒105", "공격력 증가량: 2.5⇒2.8"]],
...
class PatchContent_Darius{
  static List<String> BorNorM=["하향", "상향"];
  static List<String> patchVer=["12.10","12.6"];
  static List<String> patchNoteLink= [ PatchNoteLink.link[19], PatchNoteLink.link[23]];
  static List<List<String>> Detail_Title =[["Q - 학살"],
  ["R - 녹서스의 단두대"]];
  static List<List<List<String>>> Detail_Content =[[["챔피언 및 대형 몬스터 대상 체력 회복량 도끼날로 맞힌 적 하나당 (최대 3배) 잃은 체력의 15% ⇒ 13%"]],
...
class PatchContent_Diana{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 서늘한 달빛 검","E - 월광 쇄도"],
  ["W - 은빛 가호", "E - 월광 쇄도"],
  ["기본 지속 효과 - 서늘한 달빛 검"]];
  static List<List<List<String>>> Detail_Content =[[["강화된 범위 공격 피해량 20~250 (레벨에 따라) (+주문력의 50%) ⇒ 20~220 (레벨에 따라) (+주문력의 50%)(참고: 레벨당 기본 피해량 변화: 6레벨: 55 ⇒ 45, 11레벨: 120 ⇒ 95, 16레벨: 210 ⇒ 170)"],
...
class PatchContent_Draven{
  ...
  static List<String> patchVer=["12.16","12.10", "12.4"];
  static List<String> patchNoteLink= [PatchNoteLink.link[13], PatchNoteLink.link[19],PatchNoteLink.link[24]];
  static List<List<String>> Detail_Title =[["Q - 회전 도끼"],
  ["기본 지속 효과 - 드레이븐의 리그","Q - 회전 도끼"],
  ["기본 능력치"]];
  static List<List<List<String>>> Detail_Content =[[["기본 피해량 45/50/55/60/65 ⇒ 40/45/50/55/60"]],
...
class PatchContent_DrMundo{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[0],PatchNoteLink.link[5], PatchNoteLink.link[6],
  PatchNoteLink.link[17], PatchNoteLink.link[19],PatchNoteLink.link[25]];
  static List<List<String>> Detail_Title =[["기본 능력치","W - 심장 전기 충격","E - 둔기에 의한 외상"],
  ["기본 능력치","E - 둔기에 의한 외상"],
  ["기본 능력치" ,"기본 지속 효과 - 가고 싶은 데로 간다","Q - 오염된 뼈톱", "W - 심장 전기 충격","E - 둔기에 의한 외상","R - 최대 투여량"],
  ["기본 지속 효과 - 가고 싶은 데로 간다","R - 최대 투여량"],
  ["R - 최대 투여량"],
  ["기본 능력치","R - 최대 투여량"]];
  static List<List<List<String>>> Detail_Content =[[["기본 체력 재생: 6.5 ⇒ 7","체력 재생 증가량: 0.55 ⇒ 0.5"],
  ["다시 사용 타이머: 1초 ⇒ 0.5초"],
...
class PatchContent_Ekko{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - Z 드라이브 공진","R - 시공간 붕괴"],
  ["W - 평행 시간 교차"]];
  static List<List<List<String>>> Detail_Content =[[["세 번째 타격 효과 발동 시 피해량: 30~140 (레벨에 따라) (+주문력의 80%) ⇒ 30~140 (레벨에 따라) (+주문력의 90%)"],
...
class PatchContent_Elise{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[2],PatchNoteLink.link[9],PatchNoteLink.link[16], 
  PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["Q - 독이빨","R - 거미 형태"],
  ["Q - 신경독"],
  ["기본 능력치", "Q - 신경독 (인간 형태)"],
  ["기본 지속 효과 - 거미 여왕"]];
  static List<List<List<String>>> Detail_Content =[[["마법 피해량: 70/105/140/175/210 (+대상 잃은 체력의 8% (+주문력 100당 3%)) ⇒ 60/90/120/150/180 (+대상 잃은 체력의 8% (+주문력 100당 3%))"],
...
class PatchContent_Evelynn{
  ...
  static List<List<String>> Detail_Title =[["Q - 증오의 가시","W - 황홀한 저주"],
  ["기본 지속 효과 - 악의 장막", "W - 황홀한 저주", "R - 최후의 포옹"]];
  static List<List<List<String>>> Detail_Content =[[["표식이 부여된 대상에게 입히는 추가 마법 피해량: 10/20/30/40/50 (+주문력의 25%) ⇒ 15/25/35/45/55 (+주문력의 25%)"],
...
class PatchContent_Fiora{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 치명적인 검무","Q - 찌르기"],
  ["기본 지속 효과 - 치명적인 검무"],
  ["기본 지속 효과 - 치명적인 검무", "R - 대결투"]];
  static List<List<List<String>>> Detail_Content =[[["대상 최대 체력 비례 피해 공격력 계수: 공격력 100당 최대 체력의 4.5% 고정 피해 ⇒ 공격력 100당 최대 체력의 4% 고정 피해"],
...
class PatchContent_Fizz{
  ...
  static List<List<String>> Detail_Title =[["W - 심해석 삼지창","E - 장난치기/재간둥이"],
  ["E - 장난치기/재간둥이"],
  ["기본 능력치"]];
  static List<List<List<String>>> Detail_Content =[[["마나 회복: 20/28/36/44/52 ⇒ 30/40/50/60/70 (참고: 마나 소모량의 100%를 되돌려 받게 됩니다.)"],
...
class PatchContent_Galio{
  ...
  static List<List<String>> Detail_Title =[["W - 듀란드의 방패","E - 정의의 주먹"],
  ["Q - 전장의 돌풍"],
  ["W - 듀란드의 방패"]];
  static List<List<List<String>>> Detail_Content =[[["받는 마법 피해 감소량: 20/25/30/35/40% (+추가 마법 저항력 100당 8%)(+주문력의 5%) ⇒ 25/30/35/40/45% (+추가 마법 저항력 100당 12%)(+주문력의 5%)", "받는 물리 피해 감소량: 10/12.5/15/17.5/20% (+추가 마법 저항력 100당 4%)(+주문력의 2.5%) ⇒ 12.5/15/17.5/20/22.5% (+추가 마법 저항력 100당 6%)(+주문력의 2.5%)"],
...
class PatchContent_Gangplank{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 불의 심판","E - 화약통"],
  ["기본 능력치","E - 화약통"],
  ["기본 능력치","기본 지속 효과 - 불의 심판","Q - 혀어어어업상", "E - 화약통"],
  ["W - 괴혈병"],
  ["기본 지속 효과 - 불의 심판", "W - 괴혈병 치료"],
  ["Q - 혀어어어업상"]];
  static List<List<List<String>>> Detail_Content =[[["추가 고정 피해량: 55~310 (+추가 공격력의 100%) (+치명타 확률에 따라 0~200) ⇒ 50~250 (+추가 공격력의 100%) (+치명타 확률에 따라 0~200)"],
...
class PatchContent_Gnar{
  ...
  static List<List<String>> Detail_Title =[["기본 능력치"]];
  static List<List<List<String>>> Detail_Content =[[["기본 체력 580 ⇒ 540", "체력 재생 증가량 1.75 ⇒ 1.25"]]];
}
...
class PatchContent_Gragas{
  ...
  static List<List<String>> Detail_Title =[["Q - 술통 굴리기","E - 몸통 박치기"],
  ["기본 지속 효과 - 서비스 시간"]];
  static List<List<List<String>>> Detail_Content =[[["피해량 80/120/160/200/240 (+주문력의 70%) ⇒ 80/120/160/200/240 (+주문력의 80%)", "재사용 대기시간 11/10/9/8/7초 ⇒ 10/9/8/7/6초"],
...
class PatchContent_Graves{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 새로운 운명","R - 무고한 희생자"],
  ["Q - 화약 역류","R - 무고한 희생자"]];
  static List<List<List<String>>> Detail_Content =[[["탄환당 치명타 추가 피해: 20% ⇒ 30%"],
...
class PatchContent_Gwen{
  ...
  static List<List<String>> Detail_Title =[["Q - 싹둑싹둑!"],
  ["Q - 싹둑싹둑!"],
  ...
  static List<List<List<String>>> Detail_Content =[[["가위질당 피해량: 10/14/18/22/26 (+주문력의 5%) ⇒ 10/15/20/25/30 (+주문력의 5%)", "마지막 가위질 피해량: 60/80/100/120/140 (+주문력의 35%) ⇒ 60/85/110/135/160 (+주문력의 35%)"]],
...
class PatchContent_Hecarim{
  static List<String> BorNorM=["하향", "하향","조정","상향","하향"];
  static List<String> patchVer=["12.23","12.18","12.17","12.9","12.6"];
  static List<String> patchNoteLink= [PatchNoteLink.link[6],PatchNoteLink.link[11],PatchNoteLink.link[12],PatchNoteLink.link[20],
  PatchNoteLink.link[23]];
  static List<List<String>> Detail_Title =[["Q - 회오리 베기"],
  ["기본 능력치","Q - 회오리 베기","W - 공포의 망령"],
  ["기본 능력치","Q - 회오리 베기","W - 공포의 망령", "E - 파멸의 돌격","R - 그림자의 맹습"],
  ["Q - 회오리 베기","W - 공포의 망령"],
  ["Q - 회오리 베기", "E - 파멸의 돌격"]];
  static List<List<List<String>>> Detail_Content =[[["중첩당 추가 피해량: 4% (+추가 공격력 100당 5%) ⇒ 3% (+추가 공격력 100당 4%)"]],
...
class PatchContent_Heimerdinger{
  ...
  static List<List<String>> Detail_Title =[["Q - H-28G 진화형 포탑","W - 마법공학 초소형 로켓"],
  ["Q - H-28G 진화형 포탑","E - CH-2 전자폭풍 수류탄"]];
  static List<List<List<String>>> Detail_Content =[[["포탑 체력: 175~700 (레벨에 따라) (+주문력의 5%~40% (레벨에 따라)) ⇒ 130~640 (레벨에 따라) (+주문력의 5%~45% (레벨에 따라))"],
...
class PatchContent_Illaoi{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 고대신의 예언자"],
  ["R - 믿음의 도약"],
  ["기본 능력치","W - 혹독한 가르침"]];
  static List<List<List<String>>> Detail_Content =[[["체력 회복량 촉수가 적 챔피언에게 적중 시 잃은 체력의 5% ⇒ 4.5%"]],
...
class PatchContent_Irelia{
  ...
  ["Q - 칼날 쇄도","E - 쌍검협무"],
  ["Q - 칼날 쇄도"]];
  static List<List<List<String>>> Detail_Content =[[["기본 마법 저항력 28 ⇒ 30","방어력 증가량 4.2 ⇒ 4.7"]],
...
class PatchContent_Ivern{
  static List<String> BorNorM=["상향", "상향","상향","하향"];
  static List<String> patchVer=["13.11","12.22","12.12","12.10"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLink.link[7],PatchNoteLink.link[17], PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[
...
class PatchContent_Jax{
  ...
  static List<List<String>> Detail_Title =[["기본 능력치","E - 반격","R - 무기의 달인"],
  ["Q - 도약 공격","E - 반격","R - 달인의 저력","기타"],
  ["기본 능력치", "W - 무기 강화"]];
  static List<List<List<String>>> Detail_Content =[[["기본 체력: 685 ⇒ 665", "체력 증가량: 99 ⇒ 100"],
...
class PatchContent_Jayce{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[5],PatchNoteLink.link[9],PatchNoteLink.link[13],
  PatchNoteLink.link[22]];
  static List<List<String>> Detail_Title =[["기본 능력치","Q (해머 형태) - 하늘로!","W (해머 형태) - 전류 역장"],
  ["W - 전류 역장","R - 변환: 머큐리 해머"],
  ["Q (해머 형태) - 하늘로!","E (해머 형태) - 천둥 강타"],
  ["기본 능력치"]];
  static List<List<List<String>>> Detail_Content =[[["기본 공격력: 54 ⇒ 57"],
...
class PatchContent_Jhin{
  static List<String> BorNorM=["상향","상향"];
  static List<String> patchVer=["13.1B", "12.8"];
  static List<String> patchNoteLink= [PatchNoteLink.link[4], PatchNoteLink.link[21]];
  static List<List<String>> Detail_Title =[["기본 능력치"],
  ["W - 살상연희","E - 강제 관람"]];
  static List<List<List<String>>> Detail_Content =[[["W - 살상연희 마나 소모량: 50/60/70/80/90 ⇒ 50/55/60/65/70", "E - 강제 관람 마나 소모량: 30/35/40/45/50 ⇒ 30 (모든 스킬 레벨에서)"]],
...
class PatchContent_Jinx{
  static List<String> BorNorM=["하향","하향","상향","상향","상향","하향","하향"];
  static List<String> patchVer=["13.11", "13.9","13.5","13.1B","12.19","12.8","12.5"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLinkPlus.link[2], PatchNoteLink.link[1],PatchNoteLink.link[4], PatchNoteLink.link[10],
...
class PatchContent_Kaisa{
  ...
  static List<String> patchVer=["13.1B", "12.19","12.16","12.10","12.8"];
  static List<String> patchNoteLink= [PatchNoteLink.link[4], PatchNoteLink.link[10],PatchNoteLink.link[13], PatchNoteLink.link[19],
  PatchNoteLink.link[21]];
  static List<List<String>> Detail_Title =[["기본 능력치"],
  ["기본 지속 효과 - 두 번째 피부"],
  ...
  static List<List<List<String>>> Detail_Content =[[["기본 마나: 344.88 ⇒ 345","마나 증가량: 38 ⇒ 40", "마나 재생 증가량: 0.45 ⇒ 0.7"]],
...
class PatchContent_Kalista{
  static List<String> BorNorM=["상향", "상향","상향", "하향","하향","상향","상향"];
  static List<String> patchVer=["13.11","13.10","13.7", "12.18","12.15","12.7","12.4"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLinkPlus.link[3],PatchNoteLinkPlus.link[0], PatchNoteLink.link[11],PatchNoteLink.link[14],
...
class PatchContent_Karma{
  ...
  static List<String> patchVer=["12.10"];
  static List<String> patchNoteLink= [ PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["W - 굳은 결의","E - 고무"]];
  static List<List<List<String>>> Detail_Content =[[["(R - 만트라 강화) 체력 회복량 잃은 체력의 20% (+주문력 100당 1%) ⇒ 17% (+주문력 100당 1%)"],
...
class PatchContent_Karthus{
  ...
  static List<List<String>> Detail_Title =[["기본 능력치"],
  ["Q - 황폐화"]];
  static List<List<List<String>>> Detail_Content =[[["기본 방어력 18 ⇒ 21", "체력 증가량 101 ⇒ 110"]],
...
class PatchContent_Kassadin{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[3],PatchNoteLink.link[4],PatchNoteLink.link[6],
  PatchNoteLink.link[12],PatchNoteLink.link[21]];
  static List<List<String>> Detail_Title =[["E - 힘의 파동","R - 균열 이동"],
  ["E - 힘의 파동"],
  ["Q - 무의 구체","E - 힘의 파동"],
  ["Q - 무의 구체"],
  ["Q - 무의 구체","E - 힘의 파동"]];
  static List<List<List<String>>> Detail_Content =[[["기본 피해량: 80/105/130/155/180 (+주문력의 85%) ⇒ 60/90/120/150/180 (+주문력의 85%)", "근처 스킬 사용으로 인한 재사용 대기시간 감소: 1초 ⇒ 0.75초"],
...
class PatchContent_Kayle{
  ...
  static List<String> patchVer=["13.9","13.3","12.10"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[2],PatchNoteLink.link[3], PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[
    ["E - 화염주문검","R - 신성한 심판"],
...
class PatchContent_Kennen{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[1],PatchNoteLink.link[9],PatchNoteLink.link[14],
  PatchNoteLink.link[24]];
  static List<List<String>> Detail_Title =[["Q - 천둥의 표창","W - 전류 방출", "E - 번개 질주"],
  ["E - 번개 질주"],
  ["W - 전류 방출","R - 날카로운 소용돌이"],
  ["W - 전류 방출"]];
  static List<List<List<String>>> Detail_Content =[[["재사용 대기시간: 8/7/6/5/4초 ⇒ 7/6.25/5.5/4.75/4초","마법 피해량: 75/120/165/210/255 (+주문력의 75%) ⇒ 75/125/175/225/275 (+주문력의 85%)"],
...
class PatchContent_KSante{
  ...
  static List<List<String>> Detail_Title =[["기본 능력치","Q - 엔토포 타격","W - 길을 여는 자", "R - 총공세"],
  ["기본 능력치","기본 지속 효과 - 불굴의 본능","W - 길을 여는 자"],
  ["기본 능력치" ,"E - 발놀림"]];
  static List<List<List<String>>> Detail_Content =[[["체력 증가량: 108 ⇒ 114"],
...
class PatchContent_Leblanc{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[1],PatchNoteLink.link[3],PatchNoteLink.link[15],
  PatchNoteLink.link[26]];
  static List<List<String>> Detail_Title =[["Q - 악의의 인장","R - 모방"],
  ["기본 능력치","Q - 악의의 인장","R - 모방"],
  ["기본 능력치","W - 왜곡"],
  ["W - 왜곡"]];
  static List<List<List<String>>> Detail_Content =[[["(신규) 마나를 돌려받는 묘기: Q - 악의의 인장이나 R - 모방한 악의의 인장으로 유닛을 처치하면 마나의 100%를 돌려받고 스킬의 남은 재사용 대기시간이 30% 감소합니다.", "(신규) 미니언이 사라지는 마술: 이제 Q - 악의의 인장이 미니언에게 10~146(레벨에 따라)의 피해를 추가로 입힙니다."],
...
class PatchContent_LeeSin{
  static List<String> BorNorM=["하향","상향", "상향","상향","상향","하향","하향"];
  static List<String> patchVer=["13.7","13.3", "12.18","12.15","12.11","12.10","12.7"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[0], PatchNoteLink.link[3], PatchNoteLink.link[11],PatchNoteLink.link[14],
  ...
  ["W - 방호", "W - 강철의 의지"],
  ["기본 능력치","Q - 음파/공명의 일격"]];
  static List<List<List<String>>> Detail_Content =[[["기본 공격력: 68 ⇒ 66", "기본 방어력: 36 ⇒ 34"]],
...
class PatchContent_Lissandra{
  ...
  static List<List<String>> Detail_Title =[["기본 능력치","Q - 얼음 파편","W - 서릿발"],
  ["R - 얼음 무덤"]];
  static List<List<List<String>>> Detail_Content =[[["체력 증가량: 104 ⇒ 110"],
...
class PatchContent_Lucian{
  ...
  static List<String> patchVer=["13.1B","12.12","12.5","12.4"];
  static List<String> patchNoteLink= [PatchNoteLink.link[4],PatchNoteLink.link[17],PatchNoteLink.link[24],
  PatchNoteLink.link[25]];
  static List<List<String>> Detail_Title =[["기본 능력치"],
  ["기본 능력치", "Q - 꿰뚫는 빛"],
  ["기본 능력치","기본 지속 효과 - 경계"],
  ["Q - 꿰뚫는 빛"]];
  static List<List<List<String>>> Detail_Content =[[["기본 마나: 349 ⇒ 320", "마나 증가량: 38 ⇒ 43", "기본 마나 재생: 8.18 ⇒ 7", "마나 재생 증가량: 0.7 ⇒ 0.8"]],
...
class PatchContent_Lulu{
  ...
  static List<List<String>> Detail_Title =[["W - 변덕쟁이"],
  ["E - 도와줘, 픽스!","R - 급성장"],
  ["W - 변덕쟁이"]];
  static List<List<List<String>>> Detail_Content =[[["이동 속도 30% ⇒ 25%", "무력화 지속시간 1.25/1.5/1.75/2.0/2.25초 ⇒ 1.2/1.4/1.6/1.8/2.0초", "재사용 대기시간 17/16/15/14/13초 ⇒ 17/16.5/16/15.5/15초"]],
...
class PatchContent_Lux{
  static List<String> BorNorM=["상향","하향"];
  static List<String> patchVer=["12.23","12.10"];
  static List<String> patchNoteLink= [PatchNoteLink.link[6],  PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["E - 광휘의 특이점", "R - 최후의 섬광"],
  ["W - 프리즘 보호막"]];
  static List<List<List<String>>> Detail_Content =[[["주문력 계수 증가: 70/120/170/220/270 (+주문력의 70%) ⇒ 70/120/170/220/270 (+주문력의 80%)"],
...
class PatchContent_Malzahar{
  ...
  static List<List<String>> Detail_Title =[["E - 재앙의 환상"]];
  static List<List<List<String>>> Detail_Content =[[["(신규) 확인 사살: 이제 E - 재앙의 환상이 체력이 15~45 (1~11레벨에서) 미만인 미니언을 처형합니다."]]];
}

//마오카이
class PatchContent_Maokai{
  static List<String> BorNorM=["하향","하향","상향","상향","하향", "조정","조정","하향"];
  static List<String> patchVer=["13.4","13.1B","12.23","12.22","12.20","12.18","12.17","12.10"];
  ...
  static List<List<String>> Detail_Title =[["Q - 덤불 주먹","E - 묘목 던지기"],
  ["Q - 덤불 주먹","E - 묘목 던지기"],
  ...
  ["기본 지속 효과 - 마법 흡수"]];
  static List<List<List<String>>> Detail_Content =[[["마법 피해량: 70/120/170/220/270 (+대상 최대 체력의 2/2.25/2.5/2.75/3%) (+주문력의 40%) ⇒ 70/120/170/220/270 (+대상 최대 체력의 2/2.5/3/3.5/4%) (+주문력의 40%) (참고: 이 상향으로 총 피해량이 7% 가량 늘어나게 됩니다.)"],
...
class PatchContent_MasterYi{
  ...
  static List<List<String>> Detail_Title =[["기본 능력치","E - 우주류 검술"],
  ["E - 우주류 검술"],
  ["기본 능력치","Q - 일격 필살","W - 명상"],
  ["기본 능력치", "E - 우주류 검술"],
  ["R - 최후의 전사"],
  ["기본 능력치","Q - 일격 필살", "E - 우주류 검술"]];
  static List<List<List<String>>> Detail_Content =[[["공격력 증가량: 2.5 ⇒ 2.2"],
...
class PatchContent_MonkeyKing{
  static List<String> BorNorM=["하향", "상향","하향","조정","하향","하향","상향"];
  static List<String> patchVer=["13.7", "12.20","12.17","12.14","12.11","12.7"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[0], PatchNoteLink.link[9],PatchNoteLink.link[12],PatchNoteLink.link[15]
  ,PatchNoteLink.link[17],PatchNoteLink.link[18],PatchNoteLink.link[22]];
  static List<List<String>> Detail_Title =[["기본 능력치","W - 분신 전사","E - 근두운 급습"],
  ["R - 회전격"],
  ["기본 능력치"],
  ...
  static List<List<List<String>>> Detail_Content =[[["공격력: 68 ⇒ 66"],
...
class PatchContent_Mordekaiser{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 암흑 탄생"],
  ["W - 불멸"],
  ["기본 지속 효과 - 암흑 탄생"]];
  static List<List<List<String>>> Detail_Content =[[["몬스터 대상 최대 피해량: 180 ⇒ 28~164 (레벨에 따라)", "몬스터 대상 기본 지속 효과 발동: 모든 몬스터 타격 시 중첩 생성 ⇒ 대형 몬스터 타격 시 중첩 생성"]],
...
class PatchContent_Morgana{
  ...
  static List<String> patchVer=["12.10"];
  static List<String> patchNoteLink= [ PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 영혼 흡수"]];
  static List<List<List<String>>> Detail_Content =[[["스킬 체력 회복량 챔피언, 대형 미니언, 중형 및 대형 몬스터 대상 피해량의 20% ⇒ 18%"]]];
}
...
class PatchContent_Nami{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[4],PatchNoteLink.link[12], PatchNoteLink.link[19],
  PatchNoteLink.link[25],PatchNoteLink.link[26]];
  static List<List<String>> Detail_Title =[["W - 밀물 썰물","E - 파도 소환사의 축복"],
  ["E - 파도 소환사의 축복"],
  ["W - 밀물 썰물"],
  ["E - 파도 소환사의 축복"],
  ["기본 지속 효과 - 밀려오는 파도","E - 파도 소환사의 축복"]];
  static List<List<List<String>>> Detail_Content =[[["마법 피해량: 70/110/150/190/230 (+주문력 50%) ⇒ 60/100/140/180/220 (+주문력 55%)"],
...
class PatchContent_Nasus{
  ...
  static List<String> patchVer=["12.19","12.10"];
  static List<String> patchNoteLink= [PatchNoteLink.link[10], PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["Q - 흡수의 일격","W - 쇠약","R - 사막의 분노"],
  ["기본 지속 효과 - 영혼의 포식자"]];
  static List<List<List<String>>> Detail_Content =[[["강화된 기본 공격 사거리: 150 (추가 사거리 25) ⇒ 175 (추가 사거리 50)"],
...
class PatchContent_Nilah{
  ...
  static List<String> patchVer=["12.23", "12.13"];
  static List<String> patchNoteLink= [PatchNoteLink.link[6],PatchNoteLink.link[16]];
  static List<List<String>> Detail_Title =[["Q - 무형의 검", "R - 환희"],
  ["기본 능력치", "기본 지속 효과 - 영원한 기쁨","Q - 무형의 검 ", "E - 급류"]];
  static List<List<List<String>>> Detail_Content =[[["물리 피해량: 5/10/15/20/25 (+총 공격력의 90/100/110/120/130%) ⇒ 5/10/15/20/25 (+총 공격력의 90/97.5/105/112.5/120%)", "치명타 확률 비례 피해량 증가: 0~100%, 치명타 확률에 비례 ⇒ 0~120%, 치명타 확률에 비례", "기본 지속 효과 챔피언 대상 공격 시 (기본 및 Q - 무형의 검 사용) 체력 회복량: 감소 후 피해량의 0~15%, 치명타 확률에 비례 ⇒ 감소 후 피해량의 0~20%, 치명타 확률에 비례"],
...
class PatchContent_Nunu{
  ...
  ,PatchNoteLink.link[25]];
  static List<List<String>> Detail_Title =[["Q - 잡아먹기"],
  ["R - 절대 영도"],
  ["Q - 잡아먹기","E - 눈덩이 팡팡팡"],
  ["Q - 잡아먹기"],
  ["기본 능력치", "Q - 잡아먹기"]];
  static List<List<List<String>>> Detail_Content =[[["챔피언이 아닌 대상에게 입히는 고정 피해량: 340/500/660/820/980 ⇒ 400/600/800/1,000/1,200"]],
...
class PatchContent_Olaf{
  ...
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[0], PatchNoteLink.link[16],PatchNoteLink.link[18],
  PatchNoteLink.link[19],PatchNoteLink.link[20]];
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 광전사의 분노","Q - 역류"],
  ["기본 능력치", "기본 지속 효과 - 광전사의 분노","Q - 역류"],
  ["기본 지속 효과 - 광전사의 분노", "Q - 역류","W - 버티기", "R - 라그나로크"],
  ["W - 버티기"],
  ["기본 능력치", "기본 지속 효과 - 광전사의 분노", "Q - 역류", "W - 버티기", "R - 라그나로크"]];
  static List<List<List<String>>> Detail_Content =[[["공격 속도: 60~100% (레벨에 따라) ⇒ 50~100% (레벨에 따라)"],
...
class PatchContent_Orianna{
  ...
  static List<List<String>> Detail_Title =[["기본 능력치","W - 명령: 불협화음"],
  ["기본 지속 효과 - 시계태엽 감기","Q - 명령: 공격","W - 명령: 불협화음", "R - 명령: 충격파"],
  ["E - 명령: 보호"]];
  static List<List<List<String>>> Detail_Content =[[["기본 방어력: 17 ⇒ 20"],
...
class PatchContent_Pyke{
  ...
  static List<List<String>> Detail_Title =[["E - 망자의 물살"],
  ["기본 지속 효과 - 가라앉은 자들의 축복"],
  ["기본 지속 효과 - 가라앉은 자들의 축복","Q - 뼈 작살","R - 깊은 바다의 처형"]];
  static List<List<List<String>>> Detail_Content =[[["물리 피해량: 105/135/165/195/225 (+추가 공격력의 100%) ⇒ 105/145/185/225/265 (+추가 공격력의 100%)"]],
...
class PatchContent_Qiyana{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[1],PatchNoteLink.link[14],PatchNoteLink.link[25],
  PatchNoteLink.link[27]];
  static List<List<String>> Detail_Title =[["Q - 원소의 분노/이쉬탈의 칼날","E - 대담무쌍"],
  ["기본 지속 효과 - 왕가의 특권"],
  ["기본 지속 효과 - 왕가의 특권"],
  ["기본 능력치","Q - 이쉬탈의 칼날"]];
  static List<List<List<String>>> Detail_Content =[[["물리 피해량: 50/80/110/140/170 (+추가 공격력의 75%)⇒ 50/85/120/155/190 (+추가 공격력의 75%)"],
  ["재사용 대기시간: 12/11/10/9/8초 ⇒ 11/10/9/8/7초"]],
...
class PatchContent_Quinn{
  ...
  static List<List<String>> Detail_Title =[["W - 예리한 감각","R - 공중 강습"]];
  static List<List<List<String>>> Detail_Content =[[["추가 공격 속도 20/30/40/50/60% ⇒ 28/36/44/52/60%"],
...
class PatchContent_Rammus{
  static List<String> BorNorM=["하향", "하향","조정","하향","상향","상향","상향"];
  static List<String> patchVer=["13.7", "13.5","13.1","12.23","12.22","12.20","12.15"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[0],PatchNoteLink.link[1],PatchNoteLink.link[5],PatchNoteLink.link[6],
  PatchNoteLink.link[7],PatchNoteLink.link[9],PatchNoteLink.link[14]];
  static List<List<String>> Detail_Title =[["W - 몸 말아 웅크리기"],
  ["기본 능력치","Q - 대회전"],
  ["기본 능력치","W - 몸 말아 웅크리기"],
  ["W - 몸 말아 웅크리기"],
  ["W - 몸 말아 웅크리기"],
  ["W - 몸 말아 웅크리기","R - 지진 폭격"],
  ["R - 지진 폭격"]];
  static List<List<List<String>>> Detail_Content =[[["추가 방어력: 35 (+총 방어력의 40/55/70/85/100%) ⇒ 35 (+총 방어력의 40/50/60/70/80%)"]],
...
class PatchContent_RekSai{
  static List<String> BorNorM=["상향","하향","하향"];
  static List<String> patchVer=["13.11", "12.19","12.1"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLink.link[10],PatchNoteLink.link[28]];
  static List<List<String>> Detail_Title =[
...
class PatchContent_Rell{
  static List<String> BorNorM=["조정", "상향","하향"];
  static List<String> patchVer=["13.11","12.17","12.10"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLink.link[12], PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[
    ["기본 능력치", "기본 지속 효과 - 갑옷 파쇄", "Q - 파열의 일격", "W - 철마술: 붕괴","W - 철마술: 탑승", "E - 인력과 척력"],
    ["W - 철마술: 붕괴","E - 인력과 척력"],
  ["Q - 파멸의 일격", "W - 철마술 (붕괴)"]];
  static List<List<List<String>>> Detail_Content =[
    [["공격 속도: 0.55 ⇒ 0.625","공격 속도 증가량: 0.02 ⇒ 0.015", "방어력 증가량: 4.2 ⇒ 3", "마법 저항력 증가량: 2.05 ⇒ 1", "이동 속도: 335 ⇒ 330"],
    ["기본 지속 효과 지속시간: 4초 ⇒ 5초", "방어력 및 마법 저항력 감소량: 10% ⇒ 2.5%", "(신규)쌓고 또 쌓고: 방어력 및 마법 저항력 감소 효과가 이제 대상별로 최대 5회 중첩됩니다. 렐의 모든 스킬이 기본 지속 효과 중첩을 부여합니다.", "방어력 및 마법 저항력 최소 강탈량: 5~12 (레벨에 따라) ⇒ 1.25~3 (레벨에 따라)", "(신규)망자의 저항력: 렐이 빼앗은 방어력 및 마법 저항력은 대상이 처치되어도 전체 지속시간 동안 유지됩니다.", "(삭제)말을 타고: 이제 기본 지속 효과 - 갑옷 파쇄가 적중 시 추가 마법 피해를 입히지 않습니다.", "(삭제)석양을 향해: 이제 새로운 대상 공격을 공격해도 모든 대상에 대한 기본 지속 효과 - 갑옷 파쇄의 지속시간이 초기화되지 않습니다.", "(삭제)떠나간 그대: 이제 미니언에게는 기본 지속 효과 - 갑옷 파쇄가 적용되지 않습니다."],
    ["기절의 일격: 이제 Q - 파열의 일격이 적중한 모든 대상을 0.75초 동안 기절시킵니다.", "(삭제)체력 회복? 필요 없어: 더 이상 Q - 파열의 일격이 렐이나 아군의 체력을 회복시키지 않습니다.", "사거리: 렐의 전방으로 685 유닛, 렐의 후방으로 150 유닛 거리 ⇒ 렐의 전방으로 520 유닛, 렐의 후방으로 220 유닛 거리", "재사용 대기시간: 9/8/7/6/5초 ⇒ 11/10.5/10/9.5/9초", "마법 피해량: 70/115/160/205/250 (+주문력의 50%) ⇒ 60/95/130/165/200 (+주문력의 50%)", "스킬 사용 시간: 0.35초 ⇒ 0.5초", "(신규)정글 렐?: 정글 몬스터에게 250%의 피해를 입힙니다.", "(신규)맞았으면 좋겠네!: Q - 파열의 일격 사용 시 렐이 창을 휘두르며 전방으로 100 유닛 거리만큼 전진합니다.", "(삭제)완전한 피해: 변경 전 렐의 Q - 파열의 일격은 처음 적중한 대상에게만 기본 지속 효과 - 갑옷 파쇄의 효과를 적용했으며, 나머지 대상에게는 감소한 피해를 입혔습니다. 이제 모든 대상에게 동일한 피해를 입히고 기본 지속 효과 - 갑옷 파쇄의 효과를 적용합니다."],
    ["(신규)보행 시 추가 공격 속도: 15/20/25/30/35%", "(신규)보행 시 추가 공격 사거리: 공격 사거리가 75 늘어납니다.", "보행 시 추가 방어력 및 마법 저항력: 10% ⇒ 12%", "보행 시 이동 속도: 280의 고정값으로 감소 ⇒ 15% 감소 (참고: 게임 초반에는 하향, 후반에는 상향으로 작용할 것입니다.)", "(삭제)아무도 날 멈출 수 없어: 보행 시 최대 이동 속도 제한이 삭제되었습니다.", "마법 피해량: 70/105/140/175/210 (+주문력의 60%) ⇒ 70/100/130/160/190 (+주문력의 60%)", "보호막 흡수량: 35/60/85/110/135 (+최대 체력의 12%) ⇒ 30/55/80/105/130 (+최대 체력의 10%)", "착지 시 최대 이동 거리: 375 ⇒ 320", "스킬 범위 반지름: 200 ⇒ 180", "도약 사거리: 500 ⇒ 400", "공중에 띄우기 지속시간: 1초 ⇒ 0.75초", "착지 속도: 도약 속도의 85% ⇒ 도약 속도의 100%", "(신규)정글 렐 붐은 온다: 이제 정글 몬스터에게 250%의 피해를 입힙니다."],
    ["(삭제)탑승 시 추가 이동 속도: 더 이상 탑승 시 추가 이동 속도를 부여하지 않습니다.", "사용 시 이동 속도 증가량: 3.5초 동안 25/30/45/40/45% ⇒ 30%, 1초에 걸쳐 빠르게 감소"],
    ["(신규)기본 지속 효과 - 탑승 민첩성: 탑승 중 렐이 1~13 레벨에서 5/8/11/14/17/20/24/28/32/36/40/45/50의 이동 속도를 얻습니다. 전투 중에는 효과가 50%로 감소합니다.", "(신규)사용 시 - 전속력: 렐과 아군 하나가 돌진하며 3초에 걸쳐 이동 속도가 15/17.5/20/22.5/25%까지 서서히 증가합니다. 적이나 대상 아군을 향해 이동하면 30/35/40/45/50%까지 두 배로 증가합니다. 추가로, 렐의 다음 기본 공격이나 Q - 파열의 일격이 일정 범위로 폭발을 일으켜 25/35/45/55/65 (+주문력의 30%) (+최대 체력의 2/2.5/3/3.5/4%)에 해당하는 피해를 입힙니다."]],
...
class PatchContent_Renekton{
  static List<String> BorNorM=["상향", "하향","상향","조정"];
  static List<String> patchVer=["13.11","12.17","12.13","12.10"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLink.link[12],PatchNoteLink.link[16], PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[
    ["E - 자르고 토막내기", "R - 강신"],
    ["Q - 양떼 도륙"],
  ["R - 강신"],
...
class PatchContent_Rengar{
  static List<String> BorNorM=["하향","조정","조정","조정"];
  static List<String> patchVer=["12.11","12.7","12.6","12.2"];
  static List<String> patchNoteLink= [PatchNoteLink.link[18],PatchNoteLink.link[22],
  PatchNoteLink.link[23],PatchNoteLink.link[27]];
  static List<List<String>> Detail_Title =[["기본 능력치","R - 사냥의 전율"],
  ["Q - 포악함","W - 전투의 포효"],
  ["기본 지속 효과 - 보이지 않는 포식자", "Q - 포악함", "E - 올가미 투척","R - 사냥의 전율"],
  ["R - 사냥의 전율"]];
  static List<List<List<String>>> Detail_Content =[[["기본 체력 655 ⇒ 620"],
...
class PatchContent_Riven{
  ...
  static List<String> patchVer=["13.4","12.10"];
  static List<String> patchNoteLink= [PatchNoteLink.link[2], PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 룬 검"],
  ["E - 용맹"]];
  static List<List<List<String>>> Detail_Content =[[["추가 물리 피해량: 총 공격력의 30/36/42/48/54/60% (1/6/9/12/15/18레벨에서) ⇒ 총 공격력의 30~60% (레벨에 따라) (참고: 이제 선형적으로 성장하여, 레벨당 추가 공격력의 1.75%가 더해집니다.)", "(신규) 나뭇꾼: 이제 룬 검의 추가 피해가 포탑에도 피해를 입히지만, 추가 피해량의 50%만 적용됩니다.", "(신규) 중첩이 명료해: 리븐의 기본 지속 효과 - 룬 검의 중첩이 이제 플레이어 본인만 볼 수 있는 자원 바로 표시됩니다."]],
...
class PatchContent_Rumble{
  ...
  static List<List<String>> Detail_Title =[["E - 전기 작살"],
  ["W - 고철 방패"],
  ["기본 능력치"]];
  static List<List<List<String>>> Detail_Content =[[["작살 1회 명중 시 적 마법 저항력 감소: 10% ⇒ 12/14/16/18/20%", "작살 2회 명중 시 적 마법 저항력 감소: 20% ⇒ 24/28/32/36/40%"]],
...
class PatchContent_Ryze{
  static List<String> BorNorM=["하향","상향","상향","하향","상향"];
  static List<String> patchVer=["13.1B","12.19","12.11","12.7","12.5"];
  static List<String> patchNoteLink= [PatchNoteLink.link[4],PatchNoteLink.link[10],PatchNoteLink.link[18],
  PatchNoteLink.link[22],PatchNoteLink.link[24]];
  static List<List<String>> Detail_Title =[["기본 능력치","기본 지속 효과 - 비전 연마"],
  ["Q - 과부하","W - 룬 감옥"],
  ["Q - 과부하","E - 주문 전이"],
  ["Q - 과부하"],
  ["기본 지속 효과 - 비전 연마", "Q - 과부하"]];
  static List<List<List<String>>> Detail_Content =[[["마법 저항력: 36 ⇒ 32"],
...
class PatchContent_Samira{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[1],PatchNoteLink.link[2],PatchNoteLink.link[18],
  PatchNoteLink.link[24],PatchNoteLink.link[27]];
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 무모한 충동"],
  ["기본 지속 효과 - 무모한 충동", "R - 지옥불 난사"],
  ["기본 능력치","Q - 천부적 재능"],
  ["기본 능력치", "R - 지옥불 난사"],
  ["R - 지옥불 난사"]];
  static List<List<List<String>>> Detail_Content =[[["중첩당 이동 속도: 중첩당 1/2/3/4% (최대 6~24%) ⇒ 중첩당 2/2.5/3/3.5% (최대 12~21%)"]],
...
class PatchContent_Sejuani{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 혹한의 분노","Q - 혹한의 맹습", "R - 빙하 감옥"],
  ["기본 지속 효과 - 혹한의 분노"]];
  static List<List<List<String>>> Detail_Content =[[["에픽 몬스터 대상 최대 피해량: 300 ⇒ 250"],
...
class PatchContent_Senna{
  static List<String> BorNorM=["상향","상향","조정","하향","하향","하향","상향"];
  static List<String> patchVer=["13.4","13.1B","12.12","12.11","12.10","12.3","12.2"];
  static List<String> patchNoteLink= [PatchNoteLink.link[2],PatchNoteLink.link[4], PatchNoteLink.link[17],
  PatchNoteLink.link[18], PatchNoteLink.link[19],PatchNoteLink.link[26],PatchNoteLink.link[27]];
  static List<List<String>> Detail_Title =[["기본 능력치","R - 여명의 그림자"],
  ["기본 능력치"],
  ...
  ["기본 지속 효과 - 면죄"],
  ["Q - 꿰뚫는 어둠"]];
  static List<List<List<String>>> Detail_Content =[[["공격 속도 계수 (추가 공격 속도 100%당 공격 속도): 0.30 ⇒ 0.40"],
...
class PatchContent_Seraphine{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[15],PatchNoteLink.link[17], PatchNoteLink.link[19],
  PatchNoteLink.link[24]];
  static List<List<String>> Detail_Title =[["W - 소리 장막"],
  ["기본 지속 효과 - 무대 장악", "E - 비트 발사"],
  ["W - 소리 장막"],
  ["W - 소리 장막","E - 비트 발사"]];
  static List<List<List<String>>> Detail_Content =[[["보호막 흡수량 50/70/90/110/130 (+주문력의 35%) ⇒ 50/70/90/110/130 (+주문력의 25%)", "아군 챔피언 하나당 잃은 체력의 5/5.5/6/6.5/7% (+주문력 100당 0.6%) ⇒ 잃은 체력의 5/5.5/6/6.5/7% (+주문력 100당 0.4%)"]],
...
class PatchContent_Shaco{
  ...
  static List<List<String>> Detail_Title =[["Q - 속임수","E - 양날 독"],
  ["기본 능력치", "기본 지속 효과 - 암습","Q - 속임수", "W - 깜짝 상자", "E - 양날 독"]];
  static List<List<List<String>>> Detail_Content =[[["마나 소모량: 60 ⇒ 40", "암습 시 치명타 추가 피해량: 30% ⇒ 40%"],
...
class PatchContent_Shen{
  ...
  static List<List<String>> Detail_Title =[["E - 그림자 돌진"],
  ["기본 지속 효과 - 기 보호막", "R - 단결된 의지"],
  ["Q - 황혼 강습"]];
  static List<List<List<String>>> Detail_Content =[[["기본 지속 효과 - 기 보호막 또는 E - 그림자 돌진으로 피해를 입혔을 시 기력 회복량 30/35/40 ⇒ 30/40/50"]],
...
class PatchContent_Shyvana{
  ...
  static List<List<String>> Detail_Title =[["E - 화염 숨결"],
  ["W - 연소","E - 화염 숨결","R - 용의 강림"]];
  static List<List<List<String>>> Detail_Content =[[["표식이 남은 적 대상 강화된 기본 공격: 대상 최대 체력의 3.5% ⇒ 대상 최대 체력의 3%"]],
...
class PatchContent_Singed{
  ...
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 독성 급류", "R - 광기의 물약"],
  ["W - 초강력 접착제", "R - 광기의 물약"],
  ["Q - 맹독의 자취"]];
  static List<List<List<String>>> Detail_Content =[[["추가 이동 속도 20% ⇒ 25%", "대상별 재사용 대기시간 10초 ⇒ 8초"],
...
class PatchContent_Sivir{
  static List<String> BorNorM=["상향", "하향","하향","하향","조정"];
  static List<String> patchVer=["13.1B","12.17","12.15","12.14","12.13"];
  static List<String> patchNoteLink= [PatchNoteLink.link[4], PatchNoteLink.link[12],PatchNoteLink.link[14],PatchNoteLink.link[15],
  ...
  static List<List<List<String>>> Detail_Content =[[["마나 증가량: 40 ⇒ 45", "W - 튕기는 부메랑 마나 소모량: 60/65/70/75/80 ⇒ 60 (모든 스킬 레벨에서)"]],
...
class PatchContent_Skarner{
  ...
  static List<String> patchVer=["12.10"];
  static List<String> patchNoteLink= [ PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["W - 수정 외골격"]];
  static List<List<List<String>>> Detail_Content =[[["보호막 흡수량 최대 체력의 10/11/12/13/14% (+주문력의 80%) ⇒ 최대 체력의 9/10/11/12/13% (+주문력의 80%)"]]];
}
...
class PatchContent_Sona{
  ...
  static List<List<String>> Detail_Title =[["Q - 용맹의 찬가","E - 기민함의 노래"],
  ["W - 인내의 아리아"],
  ["기본 능력치","E - 기민함의 노래"]];
  static List<List<List<String>>> Detail_Content =[[["기본 피해량: 40/70/100/130/160 ⇒ 50/80/110/140/170"],
...
class PatchContent_Soraka{
  ...
  static List<List<String>> Detail_Title =[["R - 기원"],
  ["W - 은하의 마력" "R - 기원"],
  ["W - 은하의 마력"]];
  static List<List<List<String>>> Detail_Content =[[["체력 회복량 125/200/275 (+주문력의 50%) ⇒ 150/250/350 (+주문력의 50%)", "(삭제) 깊은 상처 이제 대상의 고통스러운 상처를 제거하지 않습니다."]],
...
class PatchContent_Sylas{
  ...
  PatchNoteLink.link[21]];
  static List<List<String>> Detail_Title =[["기본 능력치","Q - 사슬 후려치기"],
  ["W - 국왕시해자", "E - 도주/억압"],
  ["W - 국왕시해자"],
  ["R - 강탈"]];
  static List<List<List<String>>> Detail_Content =[[["기본 체력 595 ⇒ 575"],
...
class PatchContent_Syndra{
  ...
  static List<String> patchVer=["12.23","12.19"];
  static List<String> patchNoteLink= [PatchNoteLink.link[6],PatchNoteLink.link[10]];
  static List<List<String>> Detail_Title =[["W - 의지의 힘", "E - 적군 와해"],
  ["기본 능력치","기본 지속 효과 - 초월", "Q - 어둠 구체","W - 의지의 힘","E - 적군 와해","R - 풀려난 힘"]];
  static List<List<List<String>>> Detail_Content =[[["초월 강화 추가 피해량: 15% (+주문력 100당 1.5%) ⇒ 12% (+주문력 100당 2%)"],
...
class PatchContent_TahmKench{
  static List<String> BorNorM=["상향","상향","하향", "상향","하향","조정"];
  static List<String> patchVer=["12.23","12.19","12.12", "12.11","12.10","12.2"];
  static List<String> patchNoteLink= [PatchNoteLink.link[6],PatchNoteLink.link[10],PatchNoteLink.link[17], 
  PatchNoteLink.link[18], PatchNoteLink.link[19],PatchNoteLink.link[27]];
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 절대 미각", "Q - 혀 채찍", "W - 심연 잠수", "E - 두꺼운 피부", "R - 집어삼키기"],
  ["Q - 혀 채찍","W - 심연 잠수"],
  ["기본 능력치", "기본 지속 효과 - 절대 미각"],
  ["기본 지속 효과 - 절대 미각", "Q - 혀 채찍","R - 집어삼키기"],
  ["Q - 혀 채찍", "E - 두꺼운 피부"],
  ["Q - 혀 채찍", "E - 두꺼운 피부", "R - 집어삼키기"]];
  static List<List<List<String>>> Detail_Content =[[["기본 공격 및 Q - 혀 채찍 적중 시 추가 마법 피해량: 8~60 (레벨에 따라) (+추가 체력의 3%) ⇒ 8~60 (레벨에 따라) (+추가 체력의 3%) (+추가 체력 100당 주문력의 2%)"],
...
class PatchContent_Taliyah{
  static List<String> BorNorM=["조정","하향","상향","하향","하향","조정"];
  static List<String> patchVer=["13.9","12.15","12.13","12.11","12.10","12.9"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[2],PatchNoteLink.link[14],PatchNoteLink.link[16],PatchNoteLink.link[18], PatchNoteLink.link[19]
...
class PatchContent_Taric{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[12],PatchNoteLink.link[18], PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["기본 능력치","E - 황홀한 강타"],
  ["Q - 별빛 손길","E - 황홀한 강타"],
  ["Q - 별빛 손길", "W - 수호의 고리"]];
  static List<List<List<String>>> Detail_Content =[[["기본 마법 저항력 32 ⇒ 28"],
...
class PatchContent_Teemo{
  ...
  static List<String> patchVer=["12.14"];
  static List<String> patchNoteLink= [PatchNoteLink.link[15]];
  static List<List<String>> Detail_Title =[["기본 능력치","R - 유독성 함정"]];
  static List<List<List<String>>> Detail_Content =[[["마나 증가량 20 ⇒ 25"],
  ["설치 사거리 400/650/900 ⇒ 600/750/900", "피해량 200/325/450 (+주문력의 50%) ⇒ 200/325/450 (+주문력의 55%)", "마나 소모량 75 ⇒ 75/55/35"]]];
}

//쓰레쉬
class PatchContent_Thresh{
  static List<String> BorNorM=["조정", "조정","상향","상향","상향","조정"];
  static List<String> patchVer=["13.7", "13.4","13.3","12.18","12.15","12.10"];
  ...
  , PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["Q - 사형 선고"],
  ["Q - 사형 선고","W - 어둠의 통로","E - 사슬 채찍"],
  ["Q - 사형 선고","W - 어둠의 통로", "E - 사슬 채찍"],
  ["기본 능력치","E - 사슬 채찍"],
  ["Q - 사형 선고"],
  ["기본 능력치", "W - 어둠의 통로"]];
  static List<List<List<String>>> Detail_Content =[[["적중 시 돌려받는 재사용 대기시간: 3초 ⇒ 2초"]],
...
class PatchContent_Tristana{
  ...
  static List<List<String>> Detail_Title =[["Q - 속사"],
  ["기본 능력치"],
  ["기본 능력치"]];
  static List<List<List<String>>> Detail_Content =[[["추가 공격 속도 50/65/80/95/110% ⇒ 65/80/95/110/125%"]],
...
class PatchContent_Trundle{
  ...
  static List<String> patchVer=["13.9", "13.3","12.23","12.17","12.10"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[2],PatchNoteLink.link[3],PatchNoteLink.link[6],PatchNoteLink.link[12], 
  PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[
    ["기본 능력치"],
    ["W - 얼음 왕국","중요한 정보"],
...
class PatchContent_Tryndamere{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[1],PatchNoteLink.link[18], PatchNoteLink.link[19],
  PatchNoteLink.link[23]];
  static List<List<String>> Detail_Title =[["기본 능력치"],
  ["Q - 피의 갈망", "R - 불사의 분노"],
  ["Q - 피의 갈망"],
  ["E - 회전 베기", "R - 불사의 분노"]];
  static List<List<List<String>>> Detail_Content =[[["체력 증가량: 112 ⇒ 115", "공격력 증가량: 3.7 ⇒ 4"]],
...
class PatchContent_TwistedFate{
  static List<String> BorNorM=["상향", "상향","상향","하향"];
  static List<String> patchVer=["13.11", "13.1","12.17","12.3"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[4], PatchNoteLink.link[5],PatchNoteLink.link[12],PatchNoteLink.link[26]];
  static List<List<String>> Detail_Title =[
    ["W - 카드 뽑기"],
    ["Q - 와일드 카드","W - 카드 뽑기"],
  ["Q - 와일드 카드","W - 카드 뽑기"],
...
class PatchContent_Twitch{
  static List<String> BorNorM=["하향","상향","상향"];
  static List<String> patchVer=["13.5","13.1B", "12.19"];
  static List<String> patchNoteLink= [PatchNoteLink.link[1],PatchNoteLink.link[4], PatchNoteLink.link[10]];
  static List<List<String>> Detail_Title =[["E - 오염"],
  ["기본 능력치"],
  ["기본 지속 효과 - 맹독","E - 오염"]];
  static List<List<List<String>>> Detail_Content =[[["중첩당 마법 피해량: 주문력의 35% ⇒ 주문력의 30%"]],
...
class PatchContent_Varus{
  static List<String> BorNorM=["상향","하향","상향"];
  static List<String> patchVer=["12.14","12.10","12.5"];
  static List<String> patchNoteLink= [PatchNoteLink.link[15], PatchNoteLink.link[19],PatchNoteLink.link[24]];
  static List<List<String>> Detail_Title =[["기본 능력치"],
  ["E - 퍼붓는 화살"],
  ["W - 역병 화살", "R - 부패의 사슬"]];
  static List<List<List<String>>> Detail_Content =[[["기본 공격력 59 ⇒ 62"]],
...
class PatchContent_Veigar{
  ...
  ,PatchNoteLink.link[27]];
  static List<List<String>> Detail_Title =[["Q - 사악한 일격","W - 암흑 물질","E - 사건의 지평선","R - 태초의 폭발"],
  ["기본 능력치","W - 암흑 물질"],
  ["Q - 사악한 일격","W - 암흑 물질"],
  ["기본 능력치","E - 사건의 지평선"],
  ["기본 능력치","E - 사건의 지평선"],
  ["Q - 사악한 일격"]];
  static List<List<List<String>>> Detail_Content =[[["주문력 계수: 60% (모든 스킬 레벨에서) ⇒ 45/50/55/60/65%"],
...
class PatchContent_Velkoz{
  ...
  static List<List<String>> Detail_Title =[["Q - 플라즈마 분열","W - 공허 균열"]];
  static List<List<List<String>>> Detail_Content =[[["마법 피해량 80/120/160/200/240 (+주문력의 80%) ⇒ 80/120/160/200/240 (+주문력의 90%)"],
...
class PatchContent_Vex{
  ...
  static List<String> patchVer=["12.13","12.10"];
  static List<String> patchNoteLink= [PatchNoteLink.link[16], PatchNoteLink.link[19]];
  static List<List<String>> Detail_Title =[["Q - 안개 화살"],
  ["W - 거리 두기"]];
  static List<List<List<String>>> Detail_Content =[[["재사용 대기시간 9/8/7/6/5초 ⇒ 8/7/6/5/4초", "마법 피해량 60/105/150/195/240 (+주문력의 60%) ⇒ 60/105/150/195/240 (+주문력의 70%)"]],
...
class PatchContent_Vi{
  ...
  static List<List<String>> Detail_Title =[["Q - 금고 부수기","E - 끈질긴 힘"],
  ["기본 지속 효과 - 폭발 보호막"]];
  static List<List<List<String>>> Detail_Content =[[["최소 물리 피해량: 55/80/105/130/155 (+추가 공격력의 70%) ⇒ 45/70/95/120/145 (+추가 공격력의 80%)", "최대 물리 피해량: 110/160/210/260/310 (+추가 공격력의 140%) ⇒ 90/140/190/240/290 (+추가 공격력의 160%)"],
...
class PatchContent_Volibear{
  static List<String> BorNorM=["상향","하향","하향","상향"];
  static List<String> patchVer=["13.9","12.13","12.10","12.2"];
  static List<String> patchNoteLink= [PatchNoteLinkPlus.link[2],PatchNoteLink.link[16], PatchNoteLink.link[19],PatchNoteLink.link[27]];
  static List<List<String>> Detail_Title =[
    ["W - 광란의 상처"],
...
class PatchContent_Xayah{
  static List<String> BorNorM=["하향","상향","상향","하향","상향"];
  static List<String> patchVer=["13.5","13.1B","13.1","12.8","12.4"];
  static List<String> patchNoteLink= [PatchNoteLink.link[1],PatchNoteLink.link[4], PatchNoteLink.link[5],PatchNoteLink.link[21],
  PatchNoteLink.link[25]];
  static List<List<String>> Detail_Title =[["E - 깃부르미"],
  ["기본 능력치"],
  ["기본 능력치"],
  ["Q - 깃털 연타"],
  ["E - 깃부르미"]];
  static List<List<List<String>>> Detail_Content =[[["물리 피해량: 55/65/75/85/95 (+추가 공격력의 60%) ⇒ 50/60/70/80/90 (+추가 공격력의 60%)", "재사용 대기시간: 10/9.5/9/8.5/8초 ⇒ 11/10.5/10/9.5/9초"]],
...
class PatchContent_Xerath{
  ...
  static List<String> patchVer=["12.8"];
  static List<String> patchNoteLink= [PatchNoteLink.link[21]];
  static List<List<String>> Detail_Title =[["E - 충격 구체"]];
  static List<List<List<String>>> Detail_Content =[[["기절 지속시간 0.5~2초 (이동한 거리에 따라) ⇒ 0.75~2.25 (이동한 거리에 따라)"]]];
}
...
class PatchContent_XinZhao{
  ...
  static List<String> patchNoteLink= [PatchNoteLink.link[8],PatchNoteLink.link[18], PatchNoteLink.link[19],
  PatchNoteLink.link[24]];
  static List<List<String>> Detail_Title =[["기본 지속 효과 - 결심", "E - 무쌍돌격"],
  ["기본 지속 효과 - 결심","W - 풍전참뢰"],
  ["기본 지속 효과 - 결심"],
  ["E - 무쌍돌격", "R - 현월수호"]];
  static List<List<List<String>>> Detail_Content =[[["세 번째 공격 추가 피해량: 공격력의 15/25/35/45%⇒공격력의 15/30/45/60%", "체력 회복량: 6~74 (레벨에 따라) (+공격력의 10%) (+주문력의 55%)⇒6~74 (레벨에 따라) (+공격력의 10%) (+주문력의 65%)"],
  ["재사용 대기시간: 12초⇒11초"]],
...
class PatchContent_Yorick{
  ...
  static List<List<String>> Detail_Title =[["E - 애도의 안개"],
  ["기본 지속 효과 - 영혼의 길잡이", "R - 군도의 장송곡"],
  ["Q - 최후의 의식"]];
  static List<List<List<String>>> Detail_Content =[[["안개 망령 추가 피해량: 40% ⇒ 30% (참고: 추가 피해량은 안개 망령마다 최대 8회까지 적용됩니다.)"]],
...
class PatchContent_Yuumi{
  ...
  static List<List<String>> Detail_Title =[["Q - 사르르탄","R - 대단원"],
  ...
  ["기본 지속 효과 - 퐁퐁방울","E - 슈우우웅"]];
  static List<List<List<String>>> Detail_Content =[[["Q - 사르르탄이 적중한 적을 대상으로 하는 단짝의 기본 공격 적중 시 피해량: 10/12/14/16/18/20 (+주문력의 10%) ⇒ 10/12/14/16/18/20 (+주문력의 5%)","재사용 대기시간: 7.5/7.25/7/6.75/6.5/6.25초 ⇒ 6.5초 (모든 스킬 레벨에서)", "마나 소모량: 50/55/60/65/70/75 ⇒ 50/60/70/80/90/100", "밀착 해제 시 탄도체 속도: 1,000 ⇒ 850" , "강화된 탄도체 속도: 1,900 ⇒ 1,650","최대 사거리 (직선 궤적): 2,000 ⇒ 1,725" ],
...
class PatchContent_Zac{
  ...
  static List<List<String>> Detail_Title =[["W - 불안정 물질","E - 새총 발사"],
  ["기본 지속 효과 - 세포 분열", "Q - 탄성 주먹"],
  ["기본 지속 효과 - 세포 분열"]];
  static List<List<List<String>>> Detail_Content =[[["마법 피해량: 35/50/65/80/95 (+대상 최대 체력의 4/5/6/7/8% (+주문력 100당 4%)) ⇒ 35/50/65/80/95 (+대상 최대 체력의 4/5/6/7/8% (+주문력 100당 3%))"],
...
class PatchContent_Zed{
  static List<String> BorNorM=["조정","하향","상향","하향"];
  static List<String> patchVer=["13.5","12.23","12.15","12.2"];
  static List<String> patchNoteLink= [PatchNoteLink.link[1],PatchNoteLink.link[6],PatchNoteLink.link[14],PatchNoteLink.link[27]];
  static List<List<String>> Detail_Title =[["기본 능력치","E - 그림자 베기"],
  ["Q - 예리한 표창", "E - 그림자 베기"],
  ["W - 살아있는 그림자","E - 그림자 베기"],
  ["R - 죽음의 표식"]];
  static List<List<List<String>>> Detail_Content =[[["마법 저항력: 32 ⇒ 29"],
...
class PatchContent_Zeri{
  ...
  static List<String> patchVer=["13.7", "13.1","12.23","12.16","12.14","12.12","12.11","12.7","12.5", "12.4","12.3"];
  ...
  ,PatchNoteLink.link[26]];
  static List<List<String>> Detail_Title =[["기본 능력치","기본 지속 효과 - 살아있는 배터리","R - 번개 방출"],
  ["기본 능력치","Q - 집중 사격"],
  ...
  static List<List<List<String>>> Detail_Content =[[["체력 증가량: 115 ⇒ 110"],
...
class PatchContent_Ziggs{
  ...
  static List<List<String>> Detail_Title =[["Q - 반동 폭탄"]];
  static List<List<List<String>>> Detail_Content =[[["마법 피해량: 85/135/185/235/285 (+주문력의 65%) ⇒ 95/145/195/245/295 (+주문력의 65%)"]]];
}
...
class PatchContent_Zoe{
  ...
  static List<List<String>> Detail_Title =[["E - 헤롱헤롱쿨쿨방울"],
  ["W - 주문도둑","E - 헤롱헤롱쿨쿨방울"],
  ["Q - 통통별", "R - 차원 넘기"]];
  static List<List<List<String>>> Detail_Content =[[["(신규) 골치 아픈 방울: 조이의 E - 헤롱헤롱쿨쿨방울에 맞아 수면 상태에 빠진 적은 마법 저항력이 20/22.5/25/27.5/30% 감소합니다. (참고: 대상이 잠에서 깨면 해당 효과는 사라집니다.)"]],
...
class PatchContent_Zyra{
  static List<String> BorNorM=["상향"];
  static List<String> patchVer=["12.16"];
  static List<String> patchNoteLink= [PatchNoteLink.link[13],];
  static List<List<String>> Detail_Title =[["E - 휘감는 뿌리"]];
  static List<List<List<String>>> Detail_Content =[[["시전 후 행동 불가 시간 0.15~0.4초 ⇒ 0.15초"]]];
}
