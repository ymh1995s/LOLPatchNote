...
class _OneChampPageState extends State<OneChampPage> {
  ...
  Widget MakePatchContentContainer(int champNo, int index) {
    String UpdateDay="";
    if(patchVerDataArr[champNo][index] == "14.8") UpdateDay=PatchNoteLinkPlusDay.link[25];
    else if(patchVerDataArr[champNo][index] == "14.7") UpdateDay=PatchNoteLinkPlusDay.link[24];
    else if(patchVerDataArr[champNo][index] == "14.6") UpdateDay=PatchNoteLinkPlusDay.link[23];
    else if(patchVerDataArr[champNo][index] == "14.5") UpdateDay=PatchNoteLinkPlusDay.link[22];
    else if(patchVerDataArr[champNo][index] == "14.4") UpdateDay=PatchNoteLinkPlusDay.link[21];
    else if(patchVerDataArr[champNo][index] == "14.3") UpdateDay=PatchNoteLinkPlusDay.link[20];
    else if(patchVerDataArr[champNo][index] == "14.2") UpdateDay=PatchNoteLinkPlusDay.link[19];
    else if(patchVerDataArr[champNo][index] == "14.1") UpdateDay=PatchNoteLinkPlusDay.link[18];
    else if(patchVerDataArr[champNo][index] == "13.24") UpdateDay=PatchNoteLinkPlusDay.link[17];
    else if(patchVerDataArr[champNo][index] == "13.23") UpdateDay=PatchNoteLinkPlusDay.link[16];
    ...
    else if(patchVerDataArr[champNo][index] == "13.18") UpdateDay=PatchNoteLinkPlusDay.link[11];
    else if(patchVerDataArr[champNo][index] == "13.17") UpdateDay=PatchNoteLinkPlusDay.link[10];
    else if(patchVerDataArr[champNo][index] == "13.16") UpdateDay=PatchNoteLinkPlusDay.link[9];
    else if(patchVerDataArr[champNo][index] == "13.15") UpdateDay=PatchNoteLinkPlusDay.link[8];
    else if(patchVerDataArr[champNo][index] == "13.14") UpdateDay=PatchNoteLinkPlusDay.link[7];
    else if(patchVerDataArr[champNo][index] == "13.13") UpdateDay=PatchNoteLinkPlusDay.link[6];
    else if(patchVerDataArr[champNo][index] == "13.12") UpdateDay=PatchNoteLinkPlusDay.link[5];
    else if(patchVerDataArr[champNo][index] == "13.11") UpdateDay=PatchNoteLinkPlusDay.link[4];
    else if(patchVerDataArr[champNo][index] == "13.10") UpdateDay=PatchNoteLinkPlusDay.link[3];
    else if(patchVerDataArr[champNo][index] == "13.9") UpdateDay=PatchNoteLinkPlusDay.link[2];
    else if(patchVerDataArr[champNo][index] == "13.8") UpdateDay=PatchNoteLinkPlusDay.link[1];
