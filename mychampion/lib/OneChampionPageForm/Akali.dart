...
class Akali extends StatefulWidget {    
  const Akali({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Akali> createState() => _AkaliState();
}
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Akali.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [                           
                            MakeBorNorMCircle(context, PatchContent_Akali.BorNorM[0], PatchContent_Akali.patchVer[0], PatchContent_Akali.patchNoteLink[0]), 
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Akali.BorNorM[0], PatchContent_Akali.patchVer[0], PatchContent_Akali.patchNoteLink[0])
                        ],
                      ),
                    ),
                  ),
