...
class Akshan extends StatefulWidget {    
  const Akshan({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Akshan> createState() => _AkshanState();
}

class _AkshanState extends State<Akshan> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Akshan.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Akshan.BorNorM[0], PatchContent_Akshan.patchVer[0], PatchContent_Akshan.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Akshan.BorNorM[1], PatchContent_Akshan.patchVer[1], PatchContent_Akshan.patchNoteLink[1]), 
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Akshan.BorNorM[0], PatchContent_Akshan.patchVer[0], PatchContent_Akshan.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Akshan.BorNorM[1], PatchContent_Akshan.patchVer[1], PatchContent_Akshan.patchNoteLink[1]),                   
                        ],
                      ),
                    ),
                  ),
