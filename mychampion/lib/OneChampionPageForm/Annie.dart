...
class Annie extends StatefulWidget {    
  const Annie({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Annie> createState() => _AnnieState();
}

class _AnnieState extends State<Annie> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Annie.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Annie.BorNorM[0], PatchContent_Annie.patchVer[0], PatchContent_Annie.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Annie.BorNorM[1], PatchContent_Annie.patchVer[1], PatchContent_Annie.patchNoteLink[1]),                                                      
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Annie.BorNorM[0], PatchContent_Annie.patchVer[0], PatchContent_Annie.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Annie.BorNorM[1], PatchContent_Annie.patchVer[1], PatchContent_Annie.patchNoteLink[1]),                      
                        ],
                      ),
                    ),
                  ),
