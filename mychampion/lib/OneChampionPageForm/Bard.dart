...
class Bard extends StatefulWidget {    
  const Bard({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Bard.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Bard.BorNorM[0], PatchContent_Bard.patchVer[0], PatchContent_Bard.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Bard.BorNorM[1], PatchContent_Bard.patchVer[1], PatchContent_Bard.patchNoteLink[1]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Bard.BorNorM[0], PatchContent_Bard.patchVer[0], PatchContent_Bard.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Bard.BorNorM[1], PatchContent_Bard.patchVer[1], PatchContent_Bard.patchNoteLink[1]),                   
                        ],
                      ),
                    ),
                  ),
