...
class Belveth extends StatefulWidget {    
  const Belveth({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Belveth> createState() => _BelvethState();
}

class _BelvethState extends State<Belveth> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Belveth.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Belveth.BorNorM[0], PatchContent_Belveth.patchVer[0], PatchContent_Belveth.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Belveth.BorNorM[1], PatchContent_Belveth.patchVer[1], PatchContent_Belveth.patchNoteLink[1]),                                                      
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Belveth.BorNorM[0], PatchContent_Belveth.patchVer[0], PatchContent_Belveth.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Belveth.BorNorM[1], PatchContent_Belveth.patchVer[1], PatchContent_Belveth.patchNoteLink[1]),                       
                        ],
                      ),
                    ),
                  ),
