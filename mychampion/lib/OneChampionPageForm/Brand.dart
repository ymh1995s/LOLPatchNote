...
class Brand extends StatefulWidget {    
  const Brand({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Brand.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Brand.BorNorM[0], PatchContent_Brand.patchVer[0], PatchContent_Brand.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Brand.BorNorM[1], PatchContent_Brand.patchVer[1], PatchContent_Brand.patchNoteLink[1]),                                                      
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Brand.BorNorM[0], PatchContent_Brand.patchVer[0], PatchContent_Brand.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Brand.BorNorM[1], PatchContent_Brand.patchVer[1], PatchContent_Brand.patchNoteLink[1]),                   
                        ],
                      ),
                    ),
                  ),
