...
class Braum extends StatefulWidget {    
  const Braum({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Braum> createState() => _BraumState();
}

class _BraumState extends State<Braum> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Braum.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Braum.BorNorM[0], PatchContent_Braum.patchVer[0], PatchContent_Braum.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Braum.BorNorM[1], PatchContent_Braum.patchVer[1], PatchContent_Braum.patchNoteLink[1]),                                                 
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Braum.BorNorM[0], PatchContent_Braum.patchVer[0], PatchContent_Braum.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Braum.BorNorM[1], PatchContent_Braum.patchVer[1], PatchContent_Braum.patchNoteLink[1]),                     
                        ],
                      ),
                    ),
                  ),
