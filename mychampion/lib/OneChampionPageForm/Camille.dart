...
class Camille extends StatefulWidget {    
  const Camille({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Camille> createState() => _CamilleState();
}

class _CamilleState extends State<Camille> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Camille.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Camille.BorNorM[0], PatchContent_Camille.patchVer[0], PatchContent_Camille.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Camille.BorNorM[1], PatchContent_Camille.patchVer[1], PatchContent_Camille.patchNoteLink[1]),                                                    
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Camille.BorNorM[0], PatchContent_Camille.patchVer[0], PatchContent_Camille.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Camille.BorNorM[1], PatchContent_Camille.patchVer[1], PatchContent_Camille.patchNoteLink[1]),                     
                        ],
                      ),
                    ),
                  ),
