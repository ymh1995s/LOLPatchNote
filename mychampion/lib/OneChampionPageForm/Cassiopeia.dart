...
class Cassiopeia extends StatefulWidget {    
  const Cassiopeia({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Cassiopeia> createState() => _CassiopeiaState();
}

class _CassiopeiaState extends State<Cassiopeia> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Cassiopeia.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Cassiopeia.BorNorM[0], PatchContent_Cassiopeia.patchVer[0], PatchContent_Cassiopeia.patchNoteLink[0]),                                                    
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Cassiopeia.BorNorM[0], PatchContent_Cassiopeia.patchVer[0], PatchContent_Cassiopeia.patchNoteLink[0]),                     
                        ],
                      ),
                    ),
                  ),
