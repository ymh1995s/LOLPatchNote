...
class Corki extends StatefulWidget {    
  const Corki({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Corki> createState() => _CorkiState();
}

class _CorkiState extends State<Corki> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Corki.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Corki.BorNorM[0], PatchContent_Corki.patchVer[0], PatchContent_Corki.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Corki.BorNorM[1], PatchContent_Corki.patchVer[1], PatchContent_Corki.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Corki.BorNorM[2], PatchContent_Corki.patchVer[2], PatchContent_Corki.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Corki.BorNorM[0], PatchContent_Corki.patchVer[0], PatchContent_Corki.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Corki.BorNorM[1], PatchContent_Corki.patchVer[1], PatchContent_Corki.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Corki.BorNorM[2], PatchContent_Corki.patchVer[2], PatchContent_Corki.patchNoteLink[2]),                      
                        ],
                      ),
                    ),
                  ),
