...
class Darius extends StatefulWidget {    
  const Darius({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Darius> createState() => _DariusState();
}

class _DariusState extends State<Darius> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Darius.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Darius.BorNorM[0], PatchContent_Darius.patchVer[0], PatchContent_Darius.patchNoteLink[0]),                                                    
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Darius.BorNorM[0], PatchContent_Darius.patchVer[0], PatchContent_Darius.patchNoteLink[0]),                       
                        ],
                      ),
                    ),
                  ),
