...
class Diana extends StatefulWidget {    
  const Diana({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Diana.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Diana.BorNorM[0], PatchContent_Diana.patchVer[0], PatchContent_Diana.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Diana.BorNorM[1], PatchContent_Diana.patchVer[1], PatchContent_Diana.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Diana.BorNorM[2], PatchContent_Diana.patchVer[2], PatchContent_Diana.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Diana.BorNorM[0], PatchContent_Diana.patchVer[0], PatchContent_Diana.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Diana.BorNorM[1], PatchContent_Diana.patchVer[1], PatchContent_Diana.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Diana.BorNorM[2], PatchContent_Diana.patchVer[2], PatchContent_Diana.patchNoteLink[2]),                 
                        ],
                      ),
                    ),
                  ),
