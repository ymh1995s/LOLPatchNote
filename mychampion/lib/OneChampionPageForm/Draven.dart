...
class Draven extends StatefulWidget {    
  const Draven({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Draven> createState() => _DravenState();
}

class _DravenState extends State<Draven> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Draven.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Draven.BorNorM[0], PatchContent_Draven.patchVer[0], PatchContent_Draven.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Draven.BorNorM[1], PatchContent_Draven.patchVer[1], PatchContent_Draven.patchNoteLink[1]),                                                  
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Draven.BorNorM[0], PatchContent_Draven.patchVer[0], PatchContent_Draven.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Draven.BorNorM[1], PatchContent_Draven.patchVer[1], PatchContent_Draven.patchNoteLink[1]),                  
                        ],
                      ),
                    ),
                  ),
