...
class Ekko extends StatefulWidget {    
  const Ekko({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Ekko> createState() => _EkkoState();
}

class _EkkoState extends State<Ekko> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Ekko.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Ekko.BorNorM[0], PatchContent_Ekko.patchVer[0], PatchContent_Ekko.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Ekko.BorNorM[1], PatchContent_Ekko.patchVer[1], PatchContent_Ekko.patchNoteLink[1]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Ekko.BorNorM[0], PatchContent_Ekko.patchVer[0], PatchContent_Ekko.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Ekko.BorNorM[1], PatchContent_Ekko.patchVer[1], PatchContent_Ekko.patchNoteLink[1]),                     
                        ],
                      ),
                    ),
                  ),
