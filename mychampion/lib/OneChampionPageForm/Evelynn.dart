...
class Evelynn extends StatefulWidget {    
  const Evelynn({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Evelynn> createState() => _EvelynnState();
}

class _EvelynnState extends State<Evelynn> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Evelynn.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Evelynn.BorNorM[0], PatchContent_Evelynn.patchVer[0], PatchContent_Evelynn.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Evelynn.BorNorM[1], PatchContent_Evelynn.patchVer[1], PatchContent_Evelynn.patchNoteLink[1]),                                                    
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Evelynn.BorNorM[0], PatchContent_Evelynn.patchVer[0], PatchContent_Evelynn.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Evelynn.BorNorM[1], PatchContent_Evelynn.patchVer[1], PatchContent_Evelynn.patchNoteLink[1]),                       
                        ],
                      ),
                    ),
                  ),
