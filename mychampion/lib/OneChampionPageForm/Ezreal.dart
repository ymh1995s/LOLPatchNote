...
class Ezreal extends StatefulWidget {    
  const Ezreal({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Ezreal> createState() => _EzrealState();
}

class _EzrealState extends State<Ezreal> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Ezreal.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Ezreal.BorNorM[0], PatchContent_Ezreal.patchVer[0], PatchContent_Ezreal.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Ezreal.BorNorM[1], PatchContent_Ezreal.patchVer[1], PatchContent_Ezreal.patchNoteLink[1]),                                                     
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Ezreal.BorNorM[0], PatchContent_Ezreal.patchVer[0], PatchContent_Ezreal.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Ezreal.BorNorM[1], PatchContent_Ezreal.patchVer[1], PatchContent_Ezreal.patchNoteLink[1]),                     
                        ],
                      ),
                    ),
                  ),
