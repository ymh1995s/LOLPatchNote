...
class Fiora extends StatefulWidget {    
  const Fiora({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Fiora> createState() => _FioraState();
}

class _FioraState extends State<Fiora> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Fiora.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Fiora.BorNorM[0], PatchContent_Fiora.patchVer[0], PatchContent_Fiora.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Fiora.BorNorM[1], PatchContent_Fiora.patchVer[1], PatchContent_Fiora.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Fiora.BorNorM[2], PatchContent_Fiora.patchVer[2], PatchContent_Fiora.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Fiora.BorNorM[0], PatchContent_Fiora.patchVer[0], PatchContent_Fiora.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Fiora.BorNorM[1], PatchContent_Fiora.patchVer[1], PatchContent_Fiora.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Fiora.BorNorM[2], PatchContent_Fiora.patchVer[2], PatchContent_Fiora.patchNoteLink[2]),                     
                        ],
                      ),
                    ),
                  ),
