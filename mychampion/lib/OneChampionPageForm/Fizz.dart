...
class Fizz extends StatefulWidget {    
  const Fizz({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Fizz.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Fizz.BorNorM[0], PatchContent_Fizz.patchVer[0], PatchContent_Fizz.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Fizz.BorNorM[1], PatchContent_Fizz.patchVer[1], PatchContent_Fizz.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Fizz.BorNorM[2], PatchContent_Fizz.patchVer[2], PatchContent_Fizz.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Fizz.BorNorM[0], PatchContent_Fizz.patchVer[0], PatchContent_Fizz.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Fizz.BorNorM[1], PatchContent_Fizz.patchVer[1], PatchContent_Fizz.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Fizz.BorNorM[2], PatchContent_Fizz.patchVer[2], PatchContent_Fizz.patchNoteLink[2]),                 
                        ],
                      ),
                    ),
                  ),
