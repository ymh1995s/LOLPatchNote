...
class Galio extends StatefulWidget {    
  const Galio({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Galio> createState() => _GalioState();
}

class _GalioState extends State<Galio> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Galio.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Galio.BorNorM[0], PatchContent_Galio.patchVer[0], PatchContent_Galio.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Galio.BorNorM[1], PatchContent_Galio.patchVer[1], PatchContent_Galio.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Galio.BorNorM[2], PatchContent_Galio.patchVer[2], PatchContent_Galio.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Galio.BorNorM[0], PatchContent_Galio.patchVer[0], PatchContent_Galio.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Galio.BorNorM[1], PatchContent_Galio.patchVer[1], PatchContent_Galio.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Galio.BorNorM[2], PatchContent_Galio.patchVer[2], PatchContent_Galio.patchNoteLink[2]),                      
                        ],
                      ),
                    ),
                  ),
