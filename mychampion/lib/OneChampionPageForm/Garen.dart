...
class Garen extends StatefulWidget {    
  const Garen({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Garen> createState() => _GarenState();
}

class _GarenState extends State<Garen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<IsFavorite_SharedPreferencess>(
      builder: (context, Isfavorite_sharedpreferencess ,child) {
        test = Isfavorite_sharedpreferencess.IsFavoriteInClass;
        return SafeArea(
          child: Scaffold(
            appBar: AppBar(
              leading: IconButton(
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Garen.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Garen.BorNorM[0], PatchContent_Garen.patchVer[0], PatchContent_Garen.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Garen.BorNorM[1], PatchContent_Garen.patchVer[1], PatchContent_Garen.patchNoteLink[1]),     
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Garen.BorNorM[0], PatchContent_Garen.patchVer[0], PatchContent_Garen.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Garen.BorNorM[1], PatchContent_Garen.patchVer[1], PatchContent_Garen.patchNoteLink[1]),
                        ],
                      ),
                    ),
                  ),
