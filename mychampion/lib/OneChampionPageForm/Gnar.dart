...
class Gnar extends StatefulWidget {    
  const Gnar({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Gnar> createState() => _GnarState();
}

class _GnarState extends State<Gnar> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Gnar.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Gnar.BorNorM[0], PatchContent_Gnar.patchVer[0], PatchContent_Gnar.patchNoteLink[0]),                                                     
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Gnar.BorNorM[0], PatchContent_Gnar.patchVer[0], PatchContent_Gnar.patchNoteLink[0]),                      
                        ],
                      ),
                    ),
                  ),
