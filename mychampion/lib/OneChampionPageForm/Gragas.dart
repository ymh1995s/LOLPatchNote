...
class Gragas extends StatefulWidget {    
  const Gragas({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Gragas> createState() => _GragasState();
}

class _GragasState extends State<Gragas> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Gragas.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Gragas.BorNorM[0], PatchContent_Gragas.patchVer[0], PatchContent_Gragas.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Gragas.BorNorM[1], PatchContent_Gragas.patchVer[1], PatchContent_Gragas.patchNoteLink[1]),                                                      
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Gragas.BorNorM[0], PatchContent_Gragas.patchVer[0], PatchContent_Gragas.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Gragas.BorNorM[1], PatchContent_Gragas.patchVer[1], PatchContent_Gragas.patchNoteLink[1]),                 
                        ],
                      ),
                    ),
                  ),
