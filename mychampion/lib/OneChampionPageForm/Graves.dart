...
class Graves extends StatefulWidget {    
  const Graves({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Graves> createState() => _GravesState();
}

class _GravesState extends State<Graves> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Graves.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Graves.BorNorM[0], PatchContent_Graves.patchVer[0], PatchContent_Graves.patchNoteLink[0]),                                                      
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Graves.BorNorM[0], PatchContent_Graves.patchVer[0], PatchContent_Graves.patchNoteLink[0]),                     
                        ],
                      ),
                    ),
                  ),
