...
class Heimerdinger extends StatefulWidget {    
  const Heimerdinger({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Heimerdinger> createState() => _HeimerdingerState();
}

class _HeimerdingerState extends State<Heimerdinger> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Heimerdinger.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Heimerdinger.BorNorM[0], PatchContent_Heimerdinger.patchVer[0], PatchContent_Heimerdinger.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Heimerdinger.BorNorM[1], PatchContent_Heimerdinger.patchVer[1], PatchContent_Heimerdinger.patchNoteLink[1]),                                                     
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Heimerdinger.BorNorM[0], PatchContent_Heimerdinger.patchVer[0], PatchContent_Heimerdinger.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Heimerdinger.BorNorM[1], PatchContent_Heimerdinger.patchVer[1], PatchContent_Heimerdinger.patchNoteLink[1]),                   
                        ],
                      ),
                    ),
                  ),
