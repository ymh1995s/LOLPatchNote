...
class Ivern extends StatefulWidget {    
  const Ivern({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Ivern> createState() => _IvernState();
}

class _IvernState extends State<Ivern> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Ivern.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Ivern.BorNorM[0], PatchContent_Ivern.patchVer[0], PatchContent_Ivern.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Ivern.BorNorM[1], PatchContent_Ivern.patchVer[1], PatchContent_Ivern.patchNoteLink[1]),                                                    
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Ivern.BorNorM[0], PatchContent_Ivern.patchVer[0], PatchContent_Ivern.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Ivern.BorNorM[1], PatchContent_Ivern.patchVer[1], PatchContent_Ivern.patchNoteLink[1]),                     
                        ],
                      ),
                    ),
                  ),
