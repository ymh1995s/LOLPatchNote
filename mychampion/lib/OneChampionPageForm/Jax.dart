...
class Jax extends StatefulWidget {    
  const Jax({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Jax> createState() => _JaxState();
}

class _JaxState extends State<Jax> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Jax.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Jax.BorNorM[0], PatchContent_Jax.patchVer[0], PatchContent_Jax.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Jax.BorNorM[1], PatchContent_Jax.patchVer[1], PatchContent_Jax.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Jax.BorNorM[2], PatchContent_Jax.patchVer[2], PatchContent_Jax.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Jax.BorNorM[0], PatchContent_Jax.patchVer[0], PatchContent_Jax.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Jax.BorNorM[1], PatchContent_Jax.patchVer[1], PatchContent_Jax.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Jax.BorNorM[2], PatchContent_Jax.patchVer[2], PatchContent_Jax.patchNoteLink[2]),                 
                        ],
                      ),
                    ),
                  ),
