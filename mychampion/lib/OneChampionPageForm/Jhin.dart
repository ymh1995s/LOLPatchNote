...
class Jhin extends StatefulWidget {    
  const Jhin({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Jhin> createState() => _JhinState();
}

class _JhinState extends State<Jhin> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Jhin.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Jhin.BorNorM[0], PatchContent_Jhin.patchVer[0], PatchContent_Jhin.patchNoteLink[0]),                                                    
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Jhin.BorNorM[0], PatchContent_Jhin.patchVer[0], PatchContent_Jhin.patchNoteLink[0]),                  
                        ],
                      ),
                    ),
                  ),
