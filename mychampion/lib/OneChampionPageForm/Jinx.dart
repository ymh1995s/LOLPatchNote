...
class Jinx extends StatefulWidget {    
  const Jinx({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Jinx.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Jinx.BorNorM[0], PatchContent_Jinx.patchVer[0], PatchContent_Jinx.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Jinx.BorNorM[1], PatchContent_Jinx.patchVer[1], PatchContent_Jinx.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Jinx.BorNorM[2], PatchContent_Jinx.patchVer[2], PatchContent_Jinx.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Jinx.BorNorM[0], PatchContent_Jinx.patchVer[0], PatchContent_Jinx.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Jinx.BorNorM[1], PatchContent_Jinx.patchVer[1], PatchContent_Jinx.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Jinx.BorNorM[2], PatchContent_Jinx.patchVer[2], PatchContent_Jinx.patchNoteLink[2]),                    
                        ],
                      ),
                    ),
                  ),
