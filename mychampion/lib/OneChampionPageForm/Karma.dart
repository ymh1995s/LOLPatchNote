...
class Karma extends StatefulWidget {    
  const Karma({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Karma.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Karma.BorNorM[0], PatchContent_Karma.patchVer[0], PatchContent_Karma.patchNoteLink[0]),                                                      
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Karma.BorNorM[0], PatchContent_Karma.patchVer[0], PatchContent_Karma.patchNoteLink[0]),                     
                        ],
                      ),
                    ),
                  ),
