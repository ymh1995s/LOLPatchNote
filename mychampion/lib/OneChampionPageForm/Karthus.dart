...
class Karthus extends StatefulWidget {    
  const Karthus({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Karthus> createState() => _KarthusState();
}

class _KarthusState extends State<Karthus> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Karthus.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Karthus.BorNorM[0], PatchContent_Karthus.patchVer[0], PatchContent_Karthus.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Karthus.BorNorM[1], PatchContent_Karthus.patchVer[1], PatchContent_Karthus.patchNoteLink[1]),                                                      
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Karthus.BorNorM[0], PatchContent_Karthus.patchVer[0], PatchContent_Karthus.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Karthus.BorNorM[1], PatchContent_Karthus.patchVer[1], PatchContent_Karthus.patchNoteLink[1]),                     
                        ],
                      ),
                    ),
                  ),
