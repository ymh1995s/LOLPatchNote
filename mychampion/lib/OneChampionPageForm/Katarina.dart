...
class Katarina extends StatefulWidget {    
  const Katarina({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Katarina> createState() => _KatarinaState();
}

class _KatarinaState extends State<Katarina> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Katarina.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Katarina.BorNorM[0], PatchContent_Katarina.patchVer[0], PatchContent_Katarina.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Katarina.BorNorM[1], PatchContent_Katarina.patchVer[1], PatchContent_Katarina.patchNoteLink[1]),                                                  
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Katarina.BorNorM[0], PatchContent_Katarina.patchVer[0], PatchContent_Katarina.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Katarina.BorNorM[1], PatchContent_Katarina.patchVer[1], PatchContent_Katarina.patchNoteLink[1]),                   
                        ],
                      ),
                    ),
                  ),
