...
class Kayle extends StatefulWidget {    
  const Kayle({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Kayle> createState() => _KayleState();
}

class _KayleState extends State<Kayle> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Kayle.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Kayle.BorNorM[0], PatchContent_Kayle.patchVer[0], PatchContent_Kayle.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Kayle.BorNorM[1], PatchContent_Kayle.patchVer[1], PatchContent_Kayle.patchNoteLink[1]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Kayle.BorNorM[0], PatchContent_Kayle.patchVer[0], PatchContent_Kayle.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Kayle.BorNorM[1], PatchContent_Kayle.patchVer[1], PatchContent_Kayle.patchNoteLink[1]),                    
                        ],
                      ),
                    ),
                  ),
