...
class Khazix extends StatefulWidget {    
  const Khazix({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Khazix> createState() => _KhazixState();
}

class _KhazixState extends State<Khazix> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Khazix.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Khazix.BorNorM[0], PatchContent_Khazix.patchVer[0], PatchContent_Khazix.patchNoteLink[0]),                                                     
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Khazix.BorNorM[0], PatchContent_Khazix.patchVer[0], PatchContent_Khazix.patchNoteLink[0]),                    
                        ],
                      ),
                    ),
                  ),
