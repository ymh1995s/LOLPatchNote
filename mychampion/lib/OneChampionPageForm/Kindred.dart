...
class Kindred extends StatefulWidget {    
  const Kindred({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Kindred> createState() => _KindredState();
}

class _KindredState extends State<Kindred> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Kindred.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Kindred.BorNorM[0], PatchContent_Kindred.patchVer[0], PatchContent_Kindred.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Kindred.BorNorM[1], PatchContent_Kindred.patchVer[1], PatchContent_Kindred.patchNoteLink[1]),                                                     
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Kindred.BorNorM[0], PatchContent_Kindred.patchVer[0], PatchContent_Kindred.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Kindred.BorNorM[1], PatchContent_Kindred.patchVer[1], PatchContent_Kindred.patchNoteLink[1]),                  
                        ],
                      ),
                    ),
                  ),
