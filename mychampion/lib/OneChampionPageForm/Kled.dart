...
class Kled extends StatefulWidget {    
  const Kled({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Kled> createState() => _KledState();
}

class _KledState extends State<Kled> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Kled.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Kled.BorNorM[0], PatchContent_Kled.patchVer[0], PatchContent_Kled.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Kled.BorNorM[1], PatchContent_Kled.patchVer[1], PatchContent_Kled.patchNoteLink[1]),                                                     
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Kled.BorNorM[0], PatchContent_Kled.patchVer[0], PatchContent_Kled.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Kled.BorNorM[1], PatchContent_Kled.patchVer[1], PatchContent_Kled.patchNoteLink[1]),                 
                        ],
                      ),
                    ),
                  ),
