...
class KogMaw extends StatefulWidget {    
  const KogMaw({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<KogMaw> createState() => _KogMawState();
}

class _KogMawState extends State<KogMaw> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_KogMaw.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_KogMaw.BorNorM[0], PatchContent_KogMaw.patchVer[0], PatchContent_KogMaw.patchNoteLink[0]),                                                     
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_KogMaw.BorNorM[0], PatchContent_KogMaw.patchVer[0], PatchContent_KogMaw.patchNoteLink[0]),                   
                        ],
                      ),
                    ),
                  ),
