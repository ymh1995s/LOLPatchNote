...
class Leona extends StatefulWidget {    
  const Leona({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Leona> createState() => _LeonaState();
}

class _LeonaState extends State<Leona> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Leona.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Leona.BorNorM[0], PatchContent_Leona.patchVer[0], PatchContent_Leona.patchNoteLink[0]),                                                    
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Leona.BorNorM[0], PatchContent_Leona.patchVer[0], PatchContent_Leona.patchNoteLink[0]),                   
                        ],
                      ),
                    ),
                  ),
