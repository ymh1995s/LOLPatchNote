...
class Lissandra extends StatefulWidget {    
  const Lissandra({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Lissandra> createState() => _LissandraState();
}

class _LissandraState extends State<Lissandra> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Lissandra.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Lissandra.BorNorM[0], PatchContent_Lissandra.patchVer[0], PatchContent_Lissandra.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Lissandra.BorNorM[1], PatchContent_Lissandra.patchVer[1], PatchContent_Lissandra.patchNoteLink[1]),                                                     
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Lissandra.BorNorM[0], PatchContent_Lissandra.patchVer[0], PatchContent_Lissandra.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Lissandra.BorNorM[1], PatchContent_Lissandra.patchVer[1], PatchContent_Lissandra.patchNoteLink[1]),                    
                        ],
                      ),
                    ),
                  ),
