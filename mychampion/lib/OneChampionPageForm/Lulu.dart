...
class Lulu extends StatefulWidget {    
  const Lulu({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Lulu.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Lulu.BorNorM[0], PatchContent_Lulu.patchVer[0], PatchContent_Lulu.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Lulu.BorNorM[1], PatchContent_Lulu.patchVer[1], PatchContent_Lulu.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Lulu.BorNorM[2], PatchContent_Lulu.patchVer[2], PatchContent_Lulu.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Lulu.BorNorM[0], PatchContent_Lulu.patchVer[0], PatchContent_Lulu.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Lulu.BorNorM[1], PatchContent_Lulu.patchVer[1], PatchContent_Lulu.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Lulu.BorNorM[2], PatchContent_Lulu.patchVer[2], PatchContent_Lulu.patchNoteLink[2]),                   
                        ],
                      ),
                    ),
                  ),
