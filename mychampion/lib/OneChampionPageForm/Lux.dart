...
class Lux extends StatefulWidget {    
  const Lux({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Lux.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Lux.BorNorM[0], PatchContent_Lux.patchVer[0], PatchContent_Lux.patchNoteLink[0]),                                                   
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Lux.BorNorM[0], PatchContent_Lux.patchVer[0], PatchContent_Lux.patchNoteLink[0]),                   
                        ],
                      ),
                    ),
                  ),
