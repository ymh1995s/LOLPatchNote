...
class Malzahar extends StatefulWidget {    
  const Malzahar({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Malzahar> createState() => _MalzaharState();
}

class _MalzaharState extends State<Malzahar> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Malzahar.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Malzahar.BorNorM[0], PatchContent_Malzahar.patchVer[0], PatchContent_Malzahar.patchNoteLink[0]),                                                      
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Malzahar.BorNorM[0], PatchContent_Malzahar.patchVer[0], PatchContent_Malzahar.patchNoteLink[0]),                    
                        ],
                      ),
                    ),
                  ),
