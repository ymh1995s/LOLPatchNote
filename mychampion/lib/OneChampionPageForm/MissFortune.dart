...
class MissFortune extends StatefulWidget {    
  const MissFortune({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<MissFortune> createState() => _MissFortuneState();
}

class _MissFortuneState extends State<MissFortune> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_MissFortune.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_MissFortune.BorNorM[0], PatchContent_MissFortune.patchVer[0], PatchContent_MissFortune.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_MissFortune.BorNorM[1], PatchContent_MissFortune.patchVer[1], PatchContent_MissFortune.patchNoteLink[1]),                                                     
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_MissFortune.BorNorM[0], PatchContent_MissFortune.patchVer[0], PatchContent_MissFortune.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_MissFortune.BorNorM[1], PatchContent_MissFortune.patchVer[1], PatchContent_MissFortune.patchNoteLink[1]),                    
                        ],
                      ),
                    ),
                  ),
