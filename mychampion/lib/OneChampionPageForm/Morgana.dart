...
class Morgana extends StatefulWidget {    
  const Morgana({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Morgana> createState() => _MorganaState();
}

class _MorganaState extends State<Morgana> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Morgana.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Morgana.BorNorM[0], PatchContent_Morgana.patchVer[0], PatchContent_Morgana.patchNoteLink[0]),                                                      
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Morgana.BorNorM[0], PatchContent_Morgana.patchVer[0], PatchContent_Morgana.patchNoteLink[0]),                     
                        ],
                      ),
                    ),
                  ),
