...
class Nasus extends StatefulWidget {    
  const Nasus({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Nasus> createState() => _NasusState();
}

class _NasusState extends State<Nasus> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Nasus.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Nasus.BorNorM[0], PatchContent_Nasus.patchVer[0], PatchContent_Nasus.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Nasus.BorNorM[1], PatchContent_Nasus.patchVer[1], PatchContent_Nasus.patchNoteLink[1]),                                                      
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Nasus.BorNorM[0], PatchContent_Nasus.patchVer[0], PatchContent_Nasus.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Nasus.BorNorM[1], PatchContent_Nasus.patchVer[1], PatchContent_Nasus.patchNoteLink[1]),                     
                        ],
                      ),
                    ),
                  ),
