...
class Nautilus extends StatefulWidget {    
  const Nautilus({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Nautilus> createState() => _NautilusState();
}

class _NautilusState extends State<Nautilus> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Nautilus.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Nautilus.BorNorM[0], PatchContent_Nautilus.patchVer[0], PatchContent_Nautilus.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Nautilus.BorNorM[1], PatchContent_Nautilus.patchVer[1], PatchContent_Nautilus.patchNoteLink[1]),                                                    
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Nautilus.BorNorM[0], PatchContent_Nautilus.patchVer[0], PatchContent_Nautilus.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Nautilus.BorNorM[1], PatchContent_Nautilus.patchVer[1], PatchContent_Nautilus.patchNoteLink[1]),                      
                        ],
                      ),
                    ),
                  ),
