...
class Neeko extends StatefulWidget {    
  const Neeko({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Neeko> createState() => _NeekoState();
}

class _NeekoState extends State<Neeko> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Neeko.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Neeko.BorNorM[0], PatchContent_Neeko.patchVer[0], PatchContent_Neeko.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Neeko.BorNorM[1], PatchContent_Neeko.patchVer[1], PatchContent_Neeko.patchNoteLink[1]),                                                   
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Neeko.BorNorM[0], PatchContent_Neeko.patchVer[0], PatchContent_Neeko.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Neeko.BorNorM[1], PatchContent_Neeko.patchVer[1], PatchContent_Neeko.patchNoteLink[1]),                   
                        ],
                      ),
                    ),
                  ),
