...
class Ornn extends StatefulWidget {    
  const Ornn({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Ornn> createState() => _OrnnState();
}

class _OrnnState extends State<Ornn> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Ornn.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Ornn.BorNorM[0], PatchContent_Ornn.patchVer[0], PatchContent_Ornn.patchNoteLink[0]),                                                
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Ornn.BorNorM[0], PatchContent_Ornn.patchVer[0], PatchContent_Ornn.patchNoteLink[0]),                     
                        ],
                      ),
                    ),
                  ),
