...
class Poppy extends StatefulWidget {    
  const Poppy({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Poppy> createState() => _PoppyState();
}

class _PoppyState extends State<Poppy> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Poppy.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Poppy.BorNorM[0], PatchContent_Poppy.patchVer[0], PatchContent_Poppy.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Poppy.BorNorM[1], PatchContent_Poppy.patchVer[1], PatchContent_Poppy.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Poppy.BorNorM[2], PatchContent_Poppy.patchVer[2], PatchContent_Poppy.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Poppy.BorNorM[0], PatchContent_Poppy.patchVer[0], PatchContent_Poppy.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Poppy.BorNorM[1], PatchContent_Poppy.patchVer[1], PatchContent_Poppy.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Poppy.BorNorM[2], PatchContent_Poppy.patchVer[2], PatchContent_Poppy.patchNoteLink[2]),                    
                        ],
                      ),
                    ),
                  ),
