...
class Pyke extends StatefulWidget {    
  const Pyke({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Pyke> createState() => _PykeState();
}

class _PykeState extends State<Pyke> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Pyke.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Pyke.BorNorM[0], PatchContent_Pyke.patchVer[0], PatchContent_Pyke.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Pyke.BorNorM[1], PatchContent_Pyke.patchVer[1], PatchContent_Pyke.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Pyke.BorNorM[2], PatchContent_Pyke.patchVer[2], PatchContent_Pyke.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Pyke.BorNorM[0], PatchContent_Pyke.patchVer[0], PatchContent_Pyke.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Pyke.BorNorM[1], PatchContent_Pyke.patchVer[1], PatchContent_Pyke.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Pyke.BorNorM[2], PatchContent_Pyke.patchVer[2], PatchContent_Pyke.patchNoteLink[2]),                   
                        ],
                      ),
                    ),
                  ),
