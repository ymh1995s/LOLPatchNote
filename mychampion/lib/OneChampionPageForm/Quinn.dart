...
class Quinn extends StatefulWidget {    
  const Quinn({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Quinn> createState() => _QuinnState();
}

class _QuinnState extends State<Quinn> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Quinn.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Quinn.BorNorM[0], PatchContent_Quinn.patchVer[0], PatchContent_Quinn.patchNoteLink[0]),                                                 
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Quinn.BorNorM[0], PatchContent_Quinn.patchVer[0], PatchContent_Quinn.patchNoteLink[0]),                  
                        ],
                      ),
                    ),
                  ),
