...
class RekSai extends StatefulWidget {    
  const RekSai({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<RekSai> createState() => _RekSaiState();
}

class _RekSaiState extends State<RekSai> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_RekSai.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_RekSai.BorNorM[0], PatchContent_RekSai.patchVer[0], PatchContent_RekSai.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_RekSai.BorNorM[1], PatchContent_RekSai.patchVer[1], PatchContent_RekSai.patchNoteLink[1]), 
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_RekSai.BorNorM[0], PatchContent_RekSai.patchVer[0], PatchContent_RekSai.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_RekSai.BorNorM[1], PatchContent_RekSai.patchVer[1], PatchContent_RekSai.patchNoteLink[1]),                   
                        ],
                      ),
                    ),
                  ),
