...
class Rell extends StatefulWidget {    
  const Rell({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Rell> createState() => _RellState();
}

class _RellState extends State<Rell> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Rell.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Rell.BorNorM[0], PatchContent_Rell.patchVer[0], PatchContent_Rell.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Rell.BorNorM[1], PatchContent_Rell.patchVer[1], PatchContent_Rell.patchNoteLink[1]),                                                    
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Rell.BorNorM[0], PatchContent_Rell.patchVer[0], PatchContent_Rell.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Rell.BorNorM[1], PatchContent_Rell.patchVer[1], PatchContent_Rell.patchNoteLink[1]),             
                        ],
                      ),
                    ),
                  ),
