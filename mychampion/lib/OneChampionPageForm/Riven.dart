...
class Riven extends StatefulWidget {    
  const Riven({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Riven> createState() => _RivenState();
}

class _RivenState extends State<Riven> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Riven.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Riven.BorNorM[0], PatchContent_Riven.patchVer[0], PatchContent_Riven.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Riven.BorNorM[1], PatchContent_Riven.patchVer[1], PatchContent_Riven.patchNoteLink[1]),                                                 
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Riven.BorNorM[0], PatchContent_Riven.patchVer[0], PatchContent_Riven.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Riven.BorNorM[1], PatchContent_Riven.patchVer[1], PatchContent_Riven.patchNoteLink[1]),                  
                        ],
                      ),
                    ),
                  ),
