...
class Rumble extends StatefulWidget {    
  const Rumble({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Rumble.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Rumble.BorNorM[0], PatchContent_Rumble.patchVer[0], PatchContent_Rumble.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Rumble.BorNorM[1], PatchContent_Rumble.patchVer[1], PatchContent_Rumble.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Rumble.BorNorM[2], PatchContent_Rumble.patchVer[2], PatchContent_Rumble.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Rumble.BorNorM[0], PatchContent_Rumble.patchVer[0], PatchContent_Rumble.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Rumble.BorNorM[1], PatchContent_Rumble.patchVer[1], PatchContent_Rumble.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Rumble.BorNorM[2], PatchContent_Rumble.patchVer[2], PatchContent_Rumble.patchNoteLink[2]),                  
                        ],
                      ),
                    ),
                  ),
