...
class Sejuani extends StatefulWidget {    
  const Sejuani({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Sejuani> createState() => _SejuaniState();
}

class _SejuaniState extends State<Sejuani> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Sejuani.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Sejuani.BorNorM[0], PatchContent_Sejuani.patchVer[0], PatchContent_Sejuani.patchNoteLink[0]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Sejuani.BorNorM[0], PatchContent_Sejuani.patchVer[0], PatchContent_Sejuani.patchNoteLink[0]),
                          ],
                      ),
                    ),
                  ),
