...
class Sett extends StatefulWidget {    
  const Sett({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Sett.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Sett.BorNorM[0], PatchContent_Sett.patchVer[0], PatchContent_Sett.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Sett.BorNorM[1], PatchContent_Sett.patchVer[1], PatchContent_Sett.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Sett.BorNorM[2], PatchContent_Sett.patchVer[2], PatchContent_Sett.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Sett.BorNorM[0], PatchContent_Sett.patchVer[0], PatchContent_Sett.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Sett.BorNorM[1], PatchContent_Sett.patchVer[1], PatchContent_Sett.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Sett.BorNorM[2], PatchContent_Sett.patchVer[2], PatchContent_Sett.patchNoteLink[2]),
                          ],
                      ),
                    ),
                  ),
