...
class Shaco extends StatefulWidget {    
  const Shaco({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Shaco> createState() => _ShacoState();
}

class _ShacoState extends State<Shaco> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Shaco.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Shaco.BorNorM[0], PatchContent_Shaco.patchVer[0], PatchContent_Shaco.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Shaco.BorNorM[1], PatchContent_Shaco.patchVer[1], PatchContent_Shaco.patchNoteLink[1]), 
                           ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Shaco.BorNorM[0], PatchContent_Shaco.patchVer[0], PatchContent_Shaco.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Shaco.BorNorM[1], PatchContent_Shaco.patchVer[1], PatchContent_Shaco.patchNoteLink[1]),
                          ],
                      ),
                    ),
                  ),
