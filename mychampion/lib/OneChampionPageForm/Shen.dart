...
class Shen extends StatefulWidget {    
  const Shen({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Shen> createState() => _ShenState();
}

class _ShenState extends State<Shen> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Shen.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Shen.BorNorM[0], PatchContent_Shen.patchVer[0], PatchContent_Shen.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Shen.BorNorM[1], PatchContent_Shen.patchVer[1], PatchContent_Shen.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Shen.BorNorM[2], PatchContent_Shen.patchVer[2], PatchContent_Shen.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Shen.BorNorM[0], PatchContent_Shen.patchVer[0], PatchContent_Shen.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Shen.BorNorM[1], PatchContent_Shen.patchVer[1], PatchContent_Shen.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Shen.BorNorM[2], PatchContent_Shen.patchVer[2], PatchContent_Shen.patchNoteLink[2]),
                          ],
                      ),
                    ),
                  ),
