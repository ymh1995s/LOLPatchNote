...
class Shyvana extends StatefulWidget {    
  const Shyvana({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Shyvana> createState() => _ShyvanaState();
}

class _ShyvanaState extends State<Shyvana> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Shyvana.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Shyvana.BorNorM[0], PatchContent_Shyvana.patchVer[0], PatchContent_Shyvana.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Shyvana.BorNorM[1], PatchContent_Shyvana.patchVer[1], PatchContent_Shyvana.patchNoteLink[1]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Shyvana.BorNorM[0], PatchContent_Shyvana.patchVer[0], PatchContent_Shyvana.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Shyvana.BorNorM[1], PatchContent_Shyvana.patchVer[1], PatchContent_Shyvana.patchNoteLink[1]),
                          ],
                      ),
                    ),
                  ),
