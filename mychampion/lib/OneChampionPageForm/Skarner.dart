...
class Skarner extends StatefulWidget {    
  const Skarner({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Skarner> createState() => _SkarnerState();
}

class _SkarnerState extends State<Skarner> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Skarner.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Skarner.BorNorM[0], PatchContent_Skarner.patchVer[0], PatchContent_Skarner.patchNoteLink[0]), 
                           ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Skarner.BorNorM[0], PatchContent_Skarner.patchVer[0], PatchContent_Skarner.patchNoteLink[0]),
                          ],
                      ),
                    ),
                  ),
