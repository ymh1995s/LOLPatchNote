...
class Sona extends StatefulWidget {    
  const Sona({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Sona> createState() => _SonaState();
}

class _SonaState extends State<Sona> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Sona.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Sona.BorNorM[0], PatchContent_Sona.patchVer[0], PatchContent_Sona.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Sona.BorNorM[1], PatchContent_Sona.patchVer[1], PatchContent_Sona.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Sona.BorNorM[2], PatchContent_Sona.patchVer[2], PatchContent_Sona.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Sona.BorNorM[0], PatchContent_Sona.patchVer[0], PatchContent_Sona.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Sona.BorNorM[1], PatchContent_Sona.patchVer[1], PatchContent_Sona.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Sona.BorNorM[2], PatchContent_Sona.patchVer[2], PatchContent_Sona.patchNoteLink[2]),
                         ],
                      ),
                    ),
                  ),
