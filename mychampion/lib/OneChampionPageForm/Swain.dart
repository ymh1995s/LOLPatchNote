...
class Swain extends StatefulWidget {    
  const Swain({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Swain> createState() => _SwainState();
}

class _SwainState extends State<Swain> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Swain.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Swain.BorNorM[0], PatchContent_Swain.patchVer[0], PatchContent_Swain.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Swain.BorNorM[1], PatchContent_Swain.patchVer[1], PatchContent_Swain.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Swain.BorNorM[2], PatchContent_Swain.patchVer[2], PatchContent_Swain.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Swain.BorNorM[0], PatchContent_Swain.patchVer[0], PatchContent_Swain.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Swain.BorNorM[1], PatchContent_Swain.patchVer[1], PatchContent_Swain.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Swain.BorNorM[2], PatchContent_Swain.patchVer[2], PatchContent_Swain.patchNoteLink[2]),
                          ],
                      ),
                    ),
                  ),
