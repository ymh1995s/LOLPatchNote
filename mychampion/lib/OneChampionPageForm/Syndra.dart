...
class Syndra extends StatefulWidget {    
  const Syndra({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Syndra> createState() => _SyndraState();
}

class _SyndraState extends State<Syndra> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Syndra.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Syndra.BorNorM[0], PatchContent_Syndra.patchVer[0], PatchContent_Syndra.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Syndra.BorNorM[1], PatchContent_Syndra.patchVer[1], PatchContent_Syndra.patchNoteLink[1]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Syndra.BorNorM[0], PatchContent_Syndra.patchVer[0], PatchContent_Syndra.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Syndra.BorNorM[1], PatchContent_Syndra.patchVer[1], PatchContent_Syndra.patchNoteLink[1]),
                         ],
                      ),
                    ),
                  ),
