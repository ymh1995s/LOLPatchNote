...
class Talon extends StatefulWidget {    
  const Talon({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Talon> createState() => _TalonState();
}

class _TalonState extends State<Talon> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Talon.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Talon.BorNorM[0], PatchContent_Talon.patchVer[0], PatchContent_Talon.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Talon.BorNorM[1], PatchContent_Talon.patchVer[1], PatchContent_Talon.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Talon.BorNorM[2], PatchContent_Talon.patchVer[2], PatchContent_Talon.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Talon.BorNorM[0], PatchContent_Talon.patchVer[0], PatchContent_Talon.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Talon.BorNorM[1], PatchContent_Talon.patchVer[1], PatchContent_Talon.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Talon.BorNorM[2], PatchContent_Talon.patchVer[2], PatchContent_Talon.patchNoteLink[2]),
                          ],
                      ),
                    ),
                  ),
