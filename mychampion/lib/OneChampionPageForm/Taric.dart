...
class Taric extends StatefulWidget {    
  const Taric({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Taric> createState() => _TaricState();
}

class _TaricState extends State<Taric> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Taric.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Taric.BorNorM[0], PatchContent_Taric.patchVer[0], PatchContent_Taric.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Taric.BorNorM[1], PatchContent_Taric.patchVer[1], PatchContent_Taric.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Taric.BorNorM[2], PatchContent_Taric.patchVer[2], PatchContent_Taric.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Taric.BorNorM[0], PatchContent_Taric.patchVer[0], PatchContent_Taric.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Taric.BorNorM[1], PatchContent_Taric.patchVer[1], PatchContent_Taric.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Taric.BorNorM[2], PatchContent_Taric.patchVer[2], PatchContent_Taric.patchNoteLink[2]),
                         ],
                      ),
                    ),
                  ),
