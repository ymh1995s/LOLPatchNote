...
class Teemo extends StatefulWidget {    
  const Teemo({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Teemo> createState() => _TeemoState();
}

class _TeemoState extends State<Teemo> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Teemo.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Teemo.BorNorM[0], PatchContent_Teemo.patchVer[0], PatchContent_Teemo.patchNoteLink[0]), 
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Teemo.BorNorM[0], PatchContent_Teemo.patchVer[0], PatchContent_Teemo.patchNoteLink[0]),
                          ],
                      ),
                    ),
                  ),
