...
class Twitch extends StatefulWidget {    
  const Twitch({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Twitch> createState() => _TwitchState();
}
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Twitch.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Twitch.BorNorM[0], PatchContent_Twitch.patchVer[0], PatchContent_Twitch.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Twitch.BorNorM[1], PatchContent_Twitch.patchVer[1], PatchContent_Twitch.patchNoteLink[1]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Twitch.BorNorM[0], PatchContent_Twitch.patchVer[0], PatchContent_Twitch.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Twitch.BorNorM[1], PatchContent_Twitch.patchVer[1], PatchContent_Twitch.patchNoteLink[1]),
                         ],
                      ),
                    ),
                  ),
