...
class Urgot extends StatefulWidget {    
  const Urgot({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Urgot> createState() => _UrgotState();
}

class _UrgotState extends State<Urgot> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Urgot.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Urgot.BorNorM[0], PatchContent_Urgot.patchVer[0], PatchContent_Urgot.patchNoteLink[0]), 
                           ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Urgot.BorNorM[0], PatchContent_Urgot.patchVer[0], PatchContent_Urgot.patchNoteLink[0]),
                          ],
                      ),
                    ),
                  ),
