...
class Varus extends StatefulWidget {    
  const Varus({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Varus> createState() => _VarusState();
}

class _VarusState extends State<Varus> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Varus.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Varus.BorNorM[0], PatchContent_Varus.patchVer[0], PatchContent_Varus.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Varus.BorNorM[1], PatchContent_Varus.patchVer[1], PatchContent_Varus.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Varus.BorNorM[2], PatchContent_Varus.patchVer[2], PatchContent_Varus.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Varus.BorNorM[0], PatchContent_Varus.patchVer[0], PatchContent_Varus.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Varus.BorNorM[1], PatchContent_Varus.patchVer[1], PatchContent_Varus.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Varus.BorNorM[2], PatchContent_Varus.patchVer[2], PatchContent_Varus.patchNoteLink[2]),
                          ],
                      ),
                    ),
                  ),
