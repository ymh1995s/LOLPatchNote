...
class Vayne extends StatefulWidget {    
  const Vayne({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Vayne> createState() => _VayneState();
}

class _VayneState extends State<Vayne> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Vayne.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Vayne.BorNorM[0], PatchContent_Vayne.patchVer[0], PatchContent_Vayne.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Vayne.BorNorM[1], PatchContent_Vayne.patchVer[1], PatchContent_Vayne.patchNoteLink[1]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Vayne.BorNorM[0], PatchContent_Vayne.patchVer[0], PatchContent_Vayne.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Vayne.BorNorM[1], PatchContent_Vayne.patchVer[1], PatchContent_Vayne.patchNoteLink[1]),
                         ],
                      ),
                    ),
                  ),
