...
class Velkoz extends StatefulWidget {    
  const Velkoz({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Velkoz> createState() => _VelkozState();
}

class _VelkozState extends State<Velkoz> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Velkoz.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Velkoz.BorNorM[0], PatchContent_Velkoz.patchVer[0], PatchContent_Velkoz.patchNoteLink[0]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Velkoz.BorNorM[0], PatchContent_Velkoz.patchVer[0], PatchContent_Velkoz.patchNoteLink[0]),
                         ],
                      ),
                    ),
                  ),
