...
class Vex extends StatefulWidget {    
  const Vex({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Vex> createState() => _VexState();
}

class _VexState extends State<Vex> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Vex.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Vex.BorNorM[0], PatchContent_Vex.patchVer[0], PatchContent_Vex.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Vex.BorNorM[1], PatchContent_Vex.patchVer[1], PatchContent_Vex.patchNoteLink[1]), 
                           ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Vex.BorNorM[0], PatchContent_Vex.patchVer[0], PatchContent_Vex.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Vex.BorNorM[1], PatchContent_Vex.patchVer[1], PatchContent_Vex.patchNoteLink[1]),
                         ],
                      ),
                    ),
                  ),
