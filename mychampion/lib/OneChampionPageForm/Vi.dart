...
class Vi extends StatefulWidget {    
  const Vi({Key? key, required this.ChampIndex}) : super(key: key);
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Vi.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Vi.BorNorM[0], PatchContent_Vi.patchVer[0], PatchContent_Vi.patchNoteLink[0]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Vi.BorNorM[0], PatchContent_Vi.patchVer[0], PatchContent_Vi.patchNoteLink[0]),
                          ],
                      ),
                    ),
                  ),
