...
class Viego extends StatefulWidget {    
  const Viego({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Viego> createState() => _ViegoState();
}

class _ViegoState extends State<Viego> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Viego.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Viego.BorNorM[0], PatchContent_Viego.patchVer[0], PatchContent_Viego.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Viego.BorNorM[1], PatchContent_Viego.patchVer[1], PatchContent_Viego.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Viego.BorNorM[2], PatchContent_Viego.patchVer[2], PatchContent_Viego.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Viego.BorNorM[0], PatchContent_Viego.patchVer[0], PatchContent_Viego.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Viego.BorNorM[1], PatchContent_Viego.patchVer[1], PatchContent_Viego.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Viego.BorNorM[2], PatchContent_Viego.patchVer[2], PatchContent_Viego.patchNoteLink[2]),
                          ],
                      ),
                    ),
                  ),
