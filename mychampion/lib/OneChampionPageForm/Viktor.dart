...
class Viktor extends StatefulWidget {    
  const Viktor({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Viktor> createState() => _ViktorState();
}

class _ViktorState extends State<Viktor> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Viktor.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Viktor.BorNorM[0], PatchContent_Viktor.patchVer[0], PatchContent_Viktor.patchNoteLink[0]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Viktor.BorNorM[0], PatchContent_Viktor.patchVer[0], PatchContent_Viktor.patchNoteLink[0]),
                         ],
                      ),
                    ),
                  ),
