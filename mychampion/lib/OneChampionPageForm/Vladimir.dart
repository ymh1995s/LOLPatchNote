...
class Vladimir extends StatefulWidget {    
  const Vladimir({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Vladimir> createState() => _VladimirState();
}

class _VladimirState extends State<Vladimir> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Vladimir.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Vladimir.BorNorM[0], PatchContent_Vladimir.patchVer[0], PatchContent_Vladimir.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Vladimir.BorNorM[1], PatchContent_Vladimir.patchVer[1], PatchContent_Vladimir.patchNoteLink[1]), 
                           ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Vladimir.BorNorM[0], PatchContent_Vladimir.patchVer[0], PatchContent_Vladimir.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Vladimir.BorNorM[1], PatchContent_Vladimir.patchVer[1], PatchContent_Vladimir.patchNoteLink[1]),
                          ],
                      ),
                    ),
                  ),
