...
class Warwick extends StatefulWidget {    
  const Warwick({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Warwick> createState() => _WarwickState();
}

class _WarwickState extends State<Warwick> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Warwick.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Warwick.BorNorM[0], PatchContent_Warwick.patchVer[0], PatchContent_Warwick.patchNoteLink[0]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Warwick.BorNorM[0], PatchContent_Warwick.patchVer[0], PatchContent_Warwick.patchNoteLink[0]),
                         ],
                      ),
                    ),
                  ),
