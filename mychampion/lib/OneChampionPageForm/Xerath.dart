...
class Xerath extends StatefulWidget {    
  const Xerath({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Xerath> createState() => _XerathState();
}

class _XerathState extends State<Xerath> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Xerath.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Xerath.BorNorM[0], PatchContent_Xerath.patchVer[0], PatchContent_Xerath.patchNoteLink[0]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Xerath.BorNorM[0], PatchContent_Xerath.patchVer[0], PatchContent_Xerath.patchNoteLink[0]),
                          ],
                      ),
                    ),
                  ),
