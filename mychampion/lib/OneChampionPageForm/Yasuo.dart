...
class Yasuo extends StatefulWidget {    
  const Yasuo({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Yasuo> createState() => _YasuoState();
}

class _YasuoState extends State<Yasuo> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Yasuo.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Yasuo.BorNorM[0], PatchContent_Yasuo.patchVer[0], PatchContent_Yasuo.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Yasuo.BorNorM[1], PatchContent_Yasuo.patchVer[1], PatchContent_Yasuo.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Yasuo.BorNorM[2], PatchContent_Yasuo.patchVer[2], PatchContent_Yasuo.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Yasuo.BorNorM[0], PatchContent_Yasuo.patchVer[0], PatchContent_Yasuo.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Yasuo.BorNorM[1], PatchContent_Yasuo.patchVer[1], PatchContent_Yasuo.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Yasuo.BorNorM[2], PatchContent_Yasuo.patchVer[2], PatchContent_Yasuo.patchNoteLink[2]),
                          ],
                      ),
                    ),
                  ),
