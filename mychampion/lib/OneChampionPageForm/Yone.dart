...
class Yone extends StatefulWidget {    
  const Yone({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Yone> createState() => _YoneState();
}

class _YoneState extends State<Yone> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Yone.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Yone.BorNorM[0], PatchContent_Yone.patchVer[0], PatchContent_Yone.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Yone.BorNorM[1], PatchContent_Yone.patchVer[1], PatchContent_Yone.patchNoteLink[1]), 
                           ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Yone.BorNorM[0], PatchContent_Yone.patchVer[0], PatchContent_Yone.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Yone.BorNorM[1], PatchContent_Yone.patchVer[1], PatchContent_Yone.patchNoteLink[1]),
                         ],
                      ),
                    ),
                  ),
