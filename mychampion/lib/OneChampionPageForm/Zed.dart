...
class Zed extends StatefulWidget {    
  const Zed({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Zed> createState() => _ZedState();
}

class _ZedState extends State<Zed> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Zed.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Zed.BorNorM[0], PatchContent_Zed.patchVer[0], PatchContent_Zed.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Zed.BorNorM[1], PatchContent_Zed.patchVer[1], PatchContent_Zed.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Zed.BorNorM[2], PatchContent_Zed.patchVer[2], PatchContent_Zed.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Zed.BorNorM[0], PatchContent_Zed.patchVer[0], PatchContent_Zed.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Zed.BorNorM[1], PatchContent_Zed.patchVer[1], PatchContent_Zed.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Zed.BorNorM[2], PatchContent_Zed.patchVer[2], PatchContent_Zed.patchNoteLink[2]),
                         ],
                      ),
                    ),
                  ),
