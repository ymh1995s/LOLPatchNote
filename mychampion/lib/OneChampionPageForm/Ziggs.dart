...
class Ziggs extends StatefulWidget {    
  const Ziggs({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Ziggs> createState() => _ZiggsState();
}

class _ZiggsState extends State<Ziggs> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Ziggs.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Ziggs.BorNorM[0], PatchContent_Ziggs.patchVer[0], PatchContent_Ziggs.patchNoteLink[0]), 
                            ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Ziggs.BorNorM[0], PatchContent_Ziggs.patchVer[0], PatchContent_Ziggs.patchNoteLink[0]),
                         ],
                      ),
                    ),
                  ),
