...
class Zoe extends StatefulWidget {    
  const Zoe({Key? key, required this.ChampIndex}) : super(key: key);
  final int ChampIndex;

  @override
  State<Zoe> createState() => _ZoeState();
}

class _ZoeState extends State<Zoe> {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "마지막 패치 : " + PatchContent_Zoe.patchVer[0],
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MakeBorNorMCircle(context, PatchContent_Zoe.BorNorM[0], PatchContent_Zoe.patchVer[0], PatchContent_Zoe.patchNoteLink[0]), 
                            MakeBorNorMCircle(context, PatchContent_Zoe.BorNorM[1], PatchContent_Zoe.patchVer[1], PatchContent_Zoe.patchNoteLink[1]), 
                            MakeBorNorMCircle(context, PatchContent_Zoe.BorNorM[2], PatchContent_Zoe.patchVer[2], PatchContent_Zoe.patchNoteLink[2]),                                                       
                          ],
                        ),
                      ),
                    ],
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MakeHyperLink(PatchContent_Zoe.BorNorM[0], PatchContent_Zoe.patchVer[0], PatchContent_Zoe.patchNoteLink[0]),
                          MakeHyperLink(PatchContent_Zoe.BorNorM[1], PatchContent_Zoe.patchVer[1], PatchContent_Zoe.patchNoteLink[1]),
                          MakeHyperLink(PatchContent_Zoe.BorNorM[2], PatchContent_Zoe.patchVer[2], PatchContent_Zoe.patchNoteLink[2]),
                          ],
                      ),
                    ),
                  ),
